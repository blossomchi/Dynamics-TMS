<%@ WebHandler Language="VB" Class="SignatureHandler" %>
...
Public Class SignatureHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If id IsNot Nothing Then
            ...
            Dim sql As String = "SELECT * From StaffSignatureTable Where ID = @id"
