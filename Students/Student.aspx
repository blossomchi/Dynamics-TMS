<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_5ceof013" %>
...
&nbsp;<img class="xr_rn_ xr_ap" src="index_htm_files/324.png" alt="" title="" style="left: 0px; top: 0px; width: 1120px; height: 183px;"/>
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 536px; top: -32px; width: 484px; font-size:36px;margin:0;">STUDENT REGISTRATION</h3>
 </div>
 ...
 <img class="xr_rn_ xr_ap" id="autoreplace" src="index_htm_files/logo eve.png" alt="" title="" style="left: 158px; top: 41px; width: 149px; height: 133px;"/>
        <div id="xr_xri" class="xr_ap" style="width: 1120px; height: 1518px; overflow: hidden; top: 2px; left: 20px;">
            <a href="../Staff%20Dasboard/index.aspx" onclick="return(xr_nn());" target="_self">
            <img alt="HOME" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/273.png" style="left: 445px; top: 12px; width: 53px; height: 23px;" title="" /> </a><a href="#" onclick="return(xr_nn());" target="_self">
            <img alt="FACILITES" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/274.png" style="left: 497px; top: 12px; width: 79px; height: 23px;" title="" />
            <img alt="PROGRAMS" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/275.png" style="left: 575px; top: 12px; width: 86px; height: 23px;" title="" />
            <img alt="NEWS &amp; EVENT" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/276.png" style="left: 660px; top: 12px; width: 107px; height: 23px;" title="" />
            <img alt="ABOUT US" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/277.png" style="left: 766px; top: 12px; width: 80px; height: 23px;" title="" />
            <img alt="CONTACT US" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/278.png" style="left: 845px; top: 12px; width: 94px; height: 23px;" title="" /> </a><a href="../Staff%20Dasboard/StaffLogin.aspx" onclick="return(xr_nn());" target="_self">
            <img alt="STAFF" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/279.png" style="left: 938px; top: 12px; width: 56px; height: 23px;" title="" /> </a><a href="#" onclick="return(xr_nn());" target="_self">
            <img alt="STUDENTS" class="xr_rn_ xr_ap" onmousemove="xr_mo(this,0,event)" src="index_htm_files/179.png" style="left: 993px; top: 12px; width: 81px; height: 23px;" title="" /> </a>
            <div id="xr_xo0" class="xr_ap" style="left:0; top:0; width:1120px; height:100px; visibility:hidden;">
                <a href="#" onclick="return(false);">
                <img alt="HOME" class="xr_rn_ xr_ap" src="index_htm_files/283.png" style="left: 450px; top: 13px; width: 43px; height: 21px;" title="" />
                <img alt="FACILITES" class="xr_rn_ xr_ap" src="index_htm_files/284.png" style="left: 502px; top: 13px; width: 68px; height: 21px;" title="" />
                <img alt="PROGRAMS" class="xr_rn_ xr_ap" src="index_htm_files/285.png" style="left: 579px; top: 13px; width: 76px; height: 21px;" title="" />
                <img alt="NEWS &amp; EVENT" class="xr_rn_ xr_ap" src="index_htm_files/286.png" style="left: 665px; top: 13px; width: 96px; height: 21px;" title="" />
                <img alt="ABOUT US" class="xr_rn_ xr_ap" src="index_htm_files/287.png" style="left: 771px; top: 13px; width: 69px; height: 21px;" title="" />
                <img alt="CONTACT US" class="xr_rn_ xr_ap" src="index_htm_files/288.png" style="left: 850px; top: 13px; width: 83px; height: 21px;" title="" />
                <img alt="STAFF" class="xr_rn_ xr_ap" src="index_htm_files/289.png" style="left: 943px; top: 13px; width: 45px; height: 21px;" title="" />
                <img alt="STUDENTS" class="xr_rn_ xr_ap" src="index_htm_files/187.png" style="left: 998px; top: 13px; width: 71px; height: 21px;" title="" /> </a>
            </div>
            <div id="xr_xd0">
            </div>
        </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddStudents" runat="server" Text="Create Student" Width="120px" />
                    <strong style="font-weight: 700">
                    <asp:Button ID="Search" runat="server" Text="Search" Width="134px" />
                                <strong>
                    <asp:Button ID="EnterBank" runat="server" Text="Enter Bank" ToolTip="Enter bank information" Width="97px" />
                    </strong>
            ...
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="Student_Course_ID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="48" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="Student_Course_ID" HeaderText="Transaction_ID" ReadOnly="True" SortExpression="Student_Course_ID" />
                            <asp:BoundField DataField="Student NO" HeaderText="Student NO" SortExpression="Student NO" />
                             ...
                             <asp:TemplateField>
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="False" 
                                          CommandName="PrintID" ImageUrl="~/Staff/images/arrow1.png" Text="Print" ToolTip="Display Invoice" CommandArgument='<%#Eval("Student_Course_ID")%>'/>
                                  </ItemTemplate>
                                 </asp:TemplateField>
                             <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteEmployee" ImageUrl="~/Staff/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("Student_Course_ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:GridView ID="SearchStaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="Student_Course_ID" DataSourceID="SearchDDDDDS" ForeColor="Black" PageSize="25" AllowPaging="True" Visible="False">
                        <Columns>
                            <asp:BoundField DataField="Student_Course_ID" HeaderText="Transaction_ID" ReadOnly="True" SortExpression="Student_Course_ID" />
                            <asp:BoundField DataField="Student NO" HeaderText="Student NO" SortExpression="Student NO" />
                            <asp:BoundField DataField="Student Full Name" HeaderText="Student Full Name" SortExpression="Student Full Name" ReadOnly="True" />
                            <asp:BoundField DataField="Login Staff" HeaderText="Login Staff" SortExpression="Login Staff" ReadOnly="True" />
                             ...
                             <asp:TemplateField>
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Print" ImageUrl="~/Staff/images/arrow1.png" Text="Print" ToolTip="Display Invoice" CommandArgument='<%#Eval("Student_Course_ID")%>'/>
                                  </ItemTemplate>
                                 </asp:TemplateField>
                             <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SearchDDDDDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StudentCoursesTable.StudentCoursesID AS Student_Course_ID, StudentCoursesTable.StudentNO AS [Student NO], StudentTableTable.FirstName + ' ' + StudentTableTable.LastName AS [Student Full Name], StaffTable.FirstName + ' ' + StaffTable.LastName AS [Login Staff], StudentCoursesTable.RegDate FROM StaffTable INNER JOIN StudentCoursesTable ON StaffTable.StaffId = StudentCoursesTable.StaffId INNER JOIN StudentTableTable ON StudentCoursesTable.StudentNO = StudentTableTable.StudentNO WHERE (StudentCoursesTable.Comment = N'NEW STUDENT') AND (StudentCoursesTable.StudentNO = @StudentNo) ORDER BY Student_Course_ID DESC">
                        <SelectParameters>
                    ...
                    <asp:Button ID="UpdatePassport" runat="server" Text="Update" Visible="False" Width="66px" ToolTip="Update Only Passport!" />
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                ...
                                <asp:Label ID="LBStudentCourseID" runat="server" Visible="False"></asp:Label>
                                </strong></td>
                        </tr>
                        <tr>
...
<asp:Button ID="btnCapture" Text="Capture" runat="server" OnClientClick="return Capture();" />
                        ...
                        <tr>
                            <td class="style7" style="border-style: solid; border-width: 1px">Credit Limit:</td>
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                <asp:TextBox ID="txtStudentCreditLimit" runat="server" Width="240px" Wrap="False" Enabled="False"></asp:TextBox>
                            ...
                            <td class="auto-style16" valign="top" colspan="4">
                                <asp:GridView ID="GVSubCourses" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="SubCoursesDS0" ForeColor="Black" GridLines="Vertical" Width="1066px" style="font-size: 11px" DataKeyNames="ID" ShowFooter="True" PageSize="18">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:Label ID="LbRefund" runat="server" Font-Bold="true" ForeColor="Black">Refund Amount:</asp:Label><br /><br /> 
                                        ...
                                        <asp:TemplateField HeaderText="Amount Paid" SortExpression="AmountPaid">
                                         ...
                                         <asp:Label ID="LbRefundAmout" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br /><br />
