<%@ page language="VB" autoeventwireup="false" inherits="Students_Receipt, App_Web_5ceof013" %>
            ...
            <div class="xr_ap" id="xr_xri" style="width: 303px; height: auto ; clip: rect(0px, 303px, 1682px, 0px);">
                ...
                <tr>
                    <td class="style29" valign="top" colspan="2">
                        ...
                        <asp:GridView ID="CourseGV" runat="server" AutoGenerateColumns="False" DataSourceID="CourseHeadDS" style="font-size: 8pt" Width="269px" AllowPaging="True" GridLines="None" PageSize="8">
                            <Columns>
                                <asp:BoundField DataField="COURSE" HeaderText="COURSE TITLE" SortExpression="COURSE" ReadOnly="True" >
                                <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DateCreated" ReadOnly="True" SortExpression="DateCreated" Visible="False" />
                            </Columns>
                        ...
                        <br />
                        <asp:GridView ID="AllPMGV0" runat="server" AutoGenerateColumns="False" BorderStyle="None" DataSourceID="PackageDS" GridLines="None" Height="16px" style="font-size: 8pt" Width="269px" PageSize="25" DataKeyNames="StudentCoursesID" ShowHeader="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CourseAmount" SortExpression="CourseAmount" HeaderText="CourseAmount" ReadOnly="True" >
                                </asp:BoundField>
                ...
                <tr>
                    <td class="style1" colspan="2"><strong>
                        ...
                        <asp:SqlDataSource ID="SerialNumbersDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Name, DateCreated FROM CourseDetailsView WHERE (StudentCoursesID = @TransactionID) AND (DateCreated = @DateCreated)">
                            <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="PackageDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StudentCoursesID, CourseAmount, SUM(Amount) AS Amount, DateCreated FROM PackageFeesView WHERE (StudentCoursesID = @TransaID) AND (DateCreated = @Date) GROUP BY StudentCoursesID, CourseAmount, DateCreated">
                            <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="PaymentDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT StudentCoursesTable.StudentCoursesID, PaymentmethodTable.PaymentName, SUM(PaymentTable.AmountPaid) AS Amount, CONVERT (Varchar(10), PaymentTable.DateCreated, 111) AS DateCreated FROM PaymentTable INNER JOIN PaymentmethodTable ON PaymentTable.PaymentMethodTypeID = PaymentmethodTable.ID INNER JOIN StudentCoursesTable ON PaymentTable.StudentCoursesID = StudentCoursesTable.StudentCoursesID GROUP BY StudentCoursesTable.StudentCoursesID, PaymentmethodTable.PaymentName, PaymentTable.DateCreated HAVING (StudentCoursesTable.StudentCoursesID = @TransactionID) AND (CONVERT (Varchar(10), PaymentTable.DateCreated, 111) = @DateCreated)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="LBTransactionID" Name="TransactionID" PropertyName="Text" />
                                <asp:ControlParameter ControlID="LBDate" Name="DateCreated" PropertyName="Text" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="CourseHeadDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Name + ', ' + ' ' + Duration AS COURSE, DateCreated FROM CourseHead WHERE (StudentCoursesID = @TransactinoID) AND (DateCreated = @DateCreated)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="LBTransactionID" Name="TransactinoID" PropertyName="Text" />
                                <asp:ControlParameter ControlID="LBDate" Name="DateCreated" PropertyName="Text" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="AllFeesDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT CourseAmount, SUM(Amount) AS Amount, DateCreated FROM AllFessView WHERE (StudentCoursesID = @TransactionID) GROUP BY CourseAmount, DateCreated HAVING (DateCreated = @DateCreated)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="LBTransactionID" Name="TransactionID" PropertyName="Text" />
                                <asp:ControlParameter ControlID="LBDate" Name="DateCreated" PropertyName="Text" />
                            </SelectParameters>
