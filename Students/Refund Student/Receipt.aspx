<%@ page language="VB" autoeventwireup="false" inherits="Students_Receipt, App_Web_duxidmjv" %>
    ...
    <form id="formReceipt" runat="server">
      <div class="xr_ap" id="xr_xr" style="width: 303px; height: auto; top:0px; margin-left: -7px; margin-right: -7px; left: 10px; padding: 10px;">
            ...
            <div class="xr_ap" id="xr_xri" style="width: 303px; height: auto ; clip: rect(0px, 303px, 1682px, 0px);">
                ...
                <div id="xr_xd0"></div>
                <table id="ReceiptTable" runat="server" visible="True" class="auto-style1">
                <tr>
                ...
                <tr>
                    <td class="auto-style2" valign="top" colspan="2">
                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataSourceID="PaymentDS" GridLines="None" Height="50px" Width="220px">
                            <Fields>
                                <asp:BoundField DataField="PaymentName" HeaderText="Refund Type" SortExpression="PaymentName" />
                                <asp:BoundField DataField="DateCreated" HeaderText="Refund Date" SortExpression="DateCreated" />
                            </Fields>
                        </asp:DetailsView>
                    </td>
                </tr>
                <tr>
                    <td class="style25"><strong>
                        <asp:Label ID="LBBalanced" runat="server">Refund</asp:Label>
                        &nbsp;Amount</strong></td>
                    <td class="style25"><strong>
                ...
                <tr>
                    <td class="style66" colspan="2"><strong>
                        <asp:Label ID="LBReciept4" runat="server" style="text-align: left">THANK YOU.</asp:Label>
                        </strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="style1" colspan="2"><strong>
                        ...
                        <asp:SqlDataSource ID="PaymentDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT RefundPaymentTable.RefundID, PaymentmethodTable.PaymentName, SUM(RefundPaymentTable.AmountPaid) AS Expr1, RefundPaymentTable.DateCreated FROM PaymentmethodTable INNER JOIN RefundPaymentTable ON PaymentmethodTable.ID = RefundPaymentTable.PaymentMethodTypeID GROUP BY PaymentmethodTable.PaymentName, RefundPaymentTable.RefundID, RefundPaymentTable.DateCreated HAVING (RefundPaymentTable.RefundID = @RefundID)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="LBRefundStuID" Name="RefundID" PropertyName="Text" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:Label ID="LBRefundStuID" runat="server" Visible="False"></asp:Label>
