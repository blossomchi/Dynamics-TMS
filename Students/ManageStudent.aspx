<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_vdzjfouk" %>
                    ...
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="Student_Course_ID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="48" AllowPaging="True">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Login Staff" HeaderText="Login Staff" SortExpression="Login Staff" ReadOnly="True" />
                               <asp:BoundField DataField="RegDate" HeaderText="Registration Date" SortExpression="RegDate" ReadOnly="True" />
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    ...
                    <asp:Button ID="NEWStudent" runat="server" Text="New Student" Width="120px" Enabled="False" ToolTip="Click to create new student..............." />
                            ...
                            <td align="center" class="style6" rowspan="11" style="border-style: solid; border-width: 1px" valign="top">
                        ...
                        <tr>
                            <td class="auto-style11" style="border-style: solid; border-width: 1px">Last Name:</td>
...
&nbsp;Year<asp:TextBox ID="DOByearTextBox" runat="server" ToolTip="Enter year ( 1920-2190)" Width="52px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" style="border-style: solid; border-width: 1px">
                                <asp:DropDownList ID="ddState" runat="server" Width="240px" class ="chosen-select">
                        ...
                        <tr>
                            <td style="border-style: solid; border-width: 1px">BBM:</td>
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                <asp:TextBox ID="BBMtxt" runat="server" Width="240px"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                <asp:TextBox ID="txtSponsor" runat="server" Width="200px" Wrap="False"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                            <td class="style7" style="border-style: solid; border-width: 1px">Number Of Sponsor:</td>
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                <asp:TextBox ID="txtSponsorPhone" runat="server" Width="200px" Wrap="False"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                            <td class="style7" style="border-style: solid; border-width: 1px">Credit Limit:</td>
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                <asp:TextBox ID="txtStudentCreditLimit" runat="server" Width="200px" Wrap="False" Enabled="False"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" style="border-style: solid; border-width: 1px"><strong>
                                Day<strong style="font-weight: 700"><asp:DropDownList class ="chosen-select" ID="CBRegDay" runat="server" Height="24px" Width="90px">
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                                    <asp:ListItem>3</asp:ListItem>
                                    <asp:ListItem>4</asp:ListItem>
...
&nbsp;Year<asp:TextBox ID="TXTRegYear" runat="server" ToolTip="Enter year ( 1920-2190)" Width="52px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style2" style="border-style: solid; border-width: 1px">
                                <asp:Button ID="OfficeOnly" runat="server" Text="FOR OFFICE USED ONLY" Width="298px" Font-Bold="True" Font-Size="Medium" ForeColor="Maroon" />
                            </td>
                        </tr>
                        </table>
                </td>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 840px">
                    <table id="OfficeTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1091px; margin-left: 0px; height: 167px; background-image: url('../Courses/Courses/images/eeee.gif'); background-repeat: repeat;" visible="False">
                        <tr>
                            <td class="auto-style21" colspan="2" valign="top"><strong><em>FOR OFFICE USED ONLY</em></strong></td>
                        </tr>
                        <tr>
...
&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td class="auto-style20" valign="top">COURSE:</td>
                            <td class="auto-style17" valign="top">
                                <asp:DropDownList ID="cbCourses" runat="server" AutoPostBack="True" class="chosen-select" datasourceid="SubCourseDS" DataTextField="COURSES" DataValueField="SN" Height="30px" Width="629px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style20" valign="top">DURATION:</td>
                            <td class="auto-style17" valign="top">
                                <strong>
                                <asp:TextBox ID="txtDuration" runat="server" Width="207px" ReadOnly="True"></asp:TextBox>
                            &nbsp;</strong></td>
                        </tr>
                        <tr>
                    ...
                    <asp:Button ID="saveSubCourses" runat="server" onclientclick=" " Text="Save" Width="152px" ToolTip="save " />
                        ...
                        <tr>
                            <td class="auto-style16" valign="top" colspan="2">
                                <asp:GridView ID="GVSubCourses" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="SubCoursesDS0" ForeColor="Black" GridLines="Vertical" Width="1066px" style="font-size: 11px" DataKeyNames="ID" ShowFooter="True" PageSize="18">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:Label ID="DiscountLabel5" runat="server" Font-Bold="true" ForeColor="Magenta">Discount:</asp:Label><br /><br /> 
                                        ...
                                        <asp:Label ID="GrandTotal" runat="server" Font-Bold="true" ForeColor="Green"></asp:Label><br /><br />
                                     </FooterTemplate>
                                        </asp:TemplateField>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px; left: 350px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style150" rowspan="4" valign="top">
                                            <table id="PaymentDetailsTable" runat="server" style="width: 561px; height: 359px; margin-right: 0px;" visible="False">
                                                ...
                                                <tr>
                                                    <td class="style190" colspan="2" style="position: absolute; top: 250px; left: 478px;" valign="top">
                                <strong>
                                            ...
                                            <br />
                                            <br />
                                            <table id="FooterTable" runat="server" align="left" visible="False">
                                                <tr>
