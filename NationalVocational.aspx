<%@ page language="VB" autoeventwireup="false" inherits="NationalVocational, App_Web_mfpxbfvo" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-NVC</title>
...
<body>
   ...
   <div class="row header" id="container1">
       ...
       <div class="row" id="container">
           <div class="col_12">
               <div class="mainHead">
                   <h1>National Vocational Certificates</h1>
               ...
               <div class="row">
                   <div class="col_12">
                      <div class="writeup">
                          <p>National Vocational Certificate (NVC) in:
        </p>
 <ul>
                             <li>Computer Studies    - 3 years </li>
                 </ul>

                      <p>The programme leads to the award of National Vocational Certificate (NVC) which enables candidates to:</p>

                       <ul>
      <li>Gain Admissions into National Diploma programmes</li>
    ...
    <ul>
      <li>Senior Secondary School Certificate or its equivalent </li>
      <li>Junior Secondary School Certificate  </li>
           </ul>
