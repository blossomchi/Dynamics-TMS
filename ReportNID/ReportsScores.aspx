<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_3mfm3tjo" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 558px; top: -33px; width: 404px; font-size:36px;margin:0;">ACADEMY'S REPORT</h3>
 </div>
            ...
            <tr>
                <td class="style3">
                    <asp:Button ID="btnStaffHome" runat="server" Text="Staff Home" Width="106px" />
                                   <asp:DropDownList class ="chosen-select" ID="ddReports" runat="server" AutoPostBack="True" 
                     Height="28px" Width="359px">
                 </asp:DropDownList></td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <iframe id="frReports" runat="server" name="I1"></iframe><br />
                </td>
            </tr>
            <tr>
