<%@ page language="VB" autoeventwireup="false" inherits="LMS_Admin_Merge, App_Web_bbl1ev0l" %>
...
<body class="u-body">
   ...
   <header class="u-clearfix u-custom-color-1 u-header u-sticky u-header" id="sec-a944">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-dcb4">
      <div class="u-clearfix u-sheet u-sheet-1">
          <h1 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">MERGE</h1>
        <div class="u-form u-form-1">
            <asp:Panel ID="AccessLoginTable" runat="server" Visible="True">
             <div class="u-form-group u-form-name u-form-group-1">
                 <asp:DropDownList ID="DDParent" runat="server"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle" DataSourceID="DDP" DataTextField="FullName" DataValueField="ParentID" AutoPostBack="True"></asp:DropDownList>
                 
                               <asp:SqlDataSource ID="DDP" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [FullName], [ParentID] FROM [LMSParentTB]"></asp:SqlDataSource>
                 
                               </div>         
                <br/>
           <div class="u-form-group u-form-group-2">
               <asp:DropDownList ID="DDChild" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" runat="server" DataSourceID="DDC" DataTextField="Full Name" DataValueField="ApplicantID"></asp:DropDownList>
             
            
               <asp:SqlDataSource ID="DDC" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT FirstName + ' ' + LastName AS [Full Name], ApplicantID FROM ApplicantSignupTable"></asp:SqlDataSource>
            ...
            <asp:Button ID="MergeBTN" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-15" runat="server" Text="Merge"  Font-Bold="True"  />
            </div>
                       
              <div class="u-form-group u-form-group-3">
                  <asp:GridView ID="GVparentChild" CssClass="footable"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="SN" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Visible="False" Style="max-width: 100%" >
                      <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                      <Columns>
                          <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                          <asp:BoundField DataField="FullName" HeaderText="Parent Name" SortExpression="FullName" />
                      ...
                      <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                       ...
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT MergeParentChildrenTable.SN, LMSParentTB.FullName, ApplicantSignupTable.FirstName + ' ' + ApplicantSignupTable.LastName AS [Student Name] FROM ApplicantSignupTable INNER JOIN MergeParentChildrenTable ON ApplicantSignupTable.ApplicantID = MergeParentChildrenTable.ApplicantID INNER JOIN LMSParentTB ON MergeParentChildrenTable.ParentID = LMSParentTB.ParentID WHERE (LMSParentTB.ParentID = @PraentID)">
                           <SelectParameters>
                               <asp:ControlParameter ControlID="txtParentID" Name="PraentID" PropertyName="Text" />
                           </SelectParameters>
                  </asp:SqlDataSource>
                       </div>
