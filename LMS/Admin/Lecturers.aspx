<%@ page language="VB" autoeventwireup="false" inherits="LMS_Admin_Lecturers, App_Web_bbl1ev0l" %>
...
<body class="u-body">
   ...
   <header class="u-clearfix u-custom-color-1 u-header u-sticky u-header" id="sec-a944">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-dcb4">
      <div class="u-clearfix u-sheet u-sheet-1">
          <h2 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">LECTURERS MANAGEMENT</h2>
        <div class="u-form .u-Newform-1">
            <asp:Panel ID="TimeTableUpload" runat="server" Visible="True">
          <div class="u-form-group u-form-group-2">
              <asp:CheckBox ID="CheckBoxNew" runat="server" Text="NEW LECTURERS" AutoPostBack="True" /> 
               <asp:CheckBox ID="CheckBoxMigrate" runat="server" Text="EMAIL LECTURER" AutoPostBack="True" />
              </div>
                <br />
                <div class="u-form-group u-form-name u-form-group-1">
                 <asp:DropDownList ID="ddExisting" runat="server"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle" DataSourceID="SqlDataSource3" DataTextField="Staff" DataValueField="StaffId" AutoPostBack="True" Visible="False"></asp:DropDownList>
                 
                               <strong style="font-weight: 700">
                                   <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:rolfStudentConnectionString1 %>" SelectCommand="SELECT StaffTable.StaffId, StaffTable.FirstName + ' ' + StaffTable.LastName AS Staff, RoleTable.DesginationName FROM StaffTable INNER JOIN RoleTable ON StaffTable.RoleId = RoleTable.Id WHERE (RoleTable.DesginationName = N'Rector') OR (RoleTable.DesginationName = N'Administrator') OR (RoleTable.DesginationName = N'Lecturers')"></asp:SqlDataSource>
                 </strong>
                ...
                <br />
                  <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtFname" runat="server" placeholder="Please enter First Name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtLastName" runat="server" placeholder="Please enter Last Name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="Qualification" runat="server" placeholder="Please enter Qualification" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="phoneTextBox" runat="server" placeholder="Please enter phone number" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtLogin" runat="server" placeholder="Please enter username" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtPassword" runat="server" placeholder="Please enter password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" TextMode="Password" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtRetypePassword" runat="server" placeholder="Confirm Password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" TextMode="Password" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtEmail" runat="server" placeholder="Valid Email Address" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                     <asp:TextBox ID="TxtRetypeEmail" runat="server" placeholder="Confirm Email Address" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" Enabled="False"></asp:TextBox>
                     </div>
                <br />
                <div class="u-form-group u-form-name u-form-group-1">
                 <asp:DropDownList ID="DDDesgination" runat="server"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle" DataSourceID="SqlDataSource2" DataTextField="DesginationName" DataValueField="Id" AutoPostBack="True" Enabled="False"></asp:DropDownList>
                 
                               <strong style="font-weight: 700">
                                   <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:rolfStudentConnectionString1 %>" SelectCommand="SELECT Id, DesginationName FROM RoleTable WHERE (DesginationName = N'Rector') OR (DesginationName = N'Lecturers') OR (DesginationName = N'Administrator')"></asp:SqlDataSource>
                 </strong>
            ...
            <div class="u-align-center u-form-group u-form-submit u-form-group-3">
                <asp:TextBox ID="StaffIDtxt" runat="server" Visible="False" Width="20"></asp:TextBox>
            ...
            <asp:Button ID="MergeBTN" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-15" runat="server" Text="Enter / Upload"  Font-Bold="True"  />
              ...
              <div class="u-form-group u-form-group-3">
                  <asp:GridView ID="GVparentChild" CssClass="footable"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="StaffId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Style="max-width: 100%" >
                      <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                      <Columns>
                          <asp:BoundField DataField="StaffId" HeaderText="StaffId" SortExpression="StaffId" ReadOnly="True" >
                          </asp:BoundField>
                          <asp:BoundField DataField="NAME" HeaderText="NAME" SortExpression="NAME" ReadOnly="True" />
                          <asp:BoundField DataField="DesginationName" HeaderText="Desgination" SortExpression="DesginationName" />
                      </Columns>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StaffTable.StaffId, StaffTable.FirstName + ' ' + StaffTable.LastName AS NAME, RoleTable.DesginationName FROM StaffTable INNER JOIN RoleTable ON StaffTable.RoleId = RoleTable.Id WHERE (RoleTable.DesginationName = N'Administrator') OR (RoleTable.DesginationName = N'Rector') OR (RoleTable.DesginationName = N'Lecturers') ORDER BY RoleTable.DesginationName">
                  </asp:SqlDataSource>
                       </div>
