<%@ page language="VB" autoeventwireup="false" inherits="LMS_Admin_CourseAllocation, App_Web_bbl1ev0l" %>
...
<body class="u-body">
   ...
   <header class="u-clearfix u-custom-color-1 u-header u-sticky u-header" id="sec-a944">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-dcb4">
      <div class="u-clearfix u-sheet u-sheet-1">
          <h2 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">COURSE ALLOCATION PER SEMESTER</h2>
        <div class="u-form .u-Newform-1">
           ...
           <div class="u-form-group u-form-group-2">
               ...
               <asp:TextBox ID="txtMegerID" runat="server" Visible="False" Width="20px"></asp:TextBox>
             
            
               <asp:TextBox ID="StaffIDtxt" runat="server" Visible="False" Width="20px"></asp:TextBox>
             
            
               <asp:TextBox ID="txtSaveSession" runat="server" Visible="False" Width="20px"></asp:TextBox>
...
<br />
                ...
                <br />
                 <div class="u-form-group u-form-name u-form-group-1">
                  ...
                  <br />
                <div class="u-form-group u-form-name u-form-group-1">
                 <asp:DropDownList ID="ddExisting" runat="server"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle" DataSourceID="SqlDataSource3" DataTextField="Staff" DataValueField="StaffId" AutoPostBack="True"></asp:DropDownList>
                ...
                <div class="u-form-group u-form-name u-form-group-1">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2Course" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SubCourseCode, SubCourseCode + ' ' + SubCourseName AS Course FROM NIDNVCSubCourses"></asp:SqlDataSource>
                    </div>
            ...
            <asp:Button ID="MergeBTN" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-15" runat="server" Text="Enter / Upload"  Font-Bold="True"  />
              ...
              <div class="u-form-group u-form-group-3">
                  <asp:GridView ID="GVparentChild" CssClass="footable"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Style="max-width: 100%" >
                      <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                      <Columns>
                          <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" InsertVisible="False" ReadOnly="True" >
                          </asp:BoundField>
                          <asp:BoundField DataField="ProgramName" HeaderText="Program / Dpt" SortExpression="ProgramName" />
                     ...
                     <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteAllocation" ImageUrl="~/Staff/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                          </Columns>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT LecturerAllocationTable.ID, LecturerAllocationTable.ProgramName, NIDNVCYearTable.Name + ' ' + NIDNVCSemesterTable.Name AS Level, LecturerAllocationTable.Session, StaffTable.FirstName + ' ' + StaffTable.LastName AS Staff, NIDNVCSubCourses.SubCourseName FROM NIDNVDMergeTable INNER JOIN NIDNVCYearTable ON NIDNVDMergeTable.YearID = NIDNVCYearTable.YearID INNER JOIN NIDNVCSemesterTable ON NIDNVDMergeTable.SemesterID = NIDNVCSemesterTable.SemesterID INNER JOIN LecturerAllocationTable ON NIDNVDMergeTable.MergeID = LecturerAllocationTable.MergeID INNER JOIN StaffTable ON LecturerAllocationTable.Staff = StaffTable.StaffId INNER JOIN NIDNVCSubCourses ON LecturerAllocationTable.SubCourseCode = NIDNVCSubCourses.SubCourseCode WHERE (LecturerAllocationTable.Staff = @Staff) AND (LecturerAllocationTable.Session = @Session) ORDER BY LecturerAllocationTable.ID DESC">
                      <SelectParameters>
                          <asp:ControlParameter ControlID="txtStaffID" Name="Staff" PropertyName="Text" />
                          <asp:ControlParameter ControlID="txtSaveSession" Name="Session" PropertyName="Text" />
                           </SelectParameters>
                  </asp:SqlDataSource>
                       </div>
