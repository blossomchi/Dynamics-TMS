<%@ page language="VB" autoeventwireup="false" inherits="LMS_Admin_CalendarUpload, App_Web_bbl1ev0l" %>
...
<body class="u-body">
   ...
   <header class="u-clearfix u-custom-color-1 u-header u-sticky u-header" id="sec-a944">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-dcb4">
      <div class="u-clearfix u-sheet u-sheet-1">
          <h2 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">ACADEMIC CALENDAR UPLOAD</h2>
...
<br />
            ...
            <asp:Button ID="MergeBTN" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-15" runat="server" Text="Enter / Upload"  Font-Bold="True"  />
              ...
              <div class="u-form-group u-form-group-3">
                  <asp:GridView ID="GVparentChild" CssClass="footable"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Style="max-width: 100%" >
                      <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                      <Columns>
                          <asp:BoundField DataField="CalendarID" HeaderText="Calendar ID" SortExpression="CalendarID" >
                          <HeaderStyle HorizontalAlign="Left" />
                          </asp:BoundField>
                          <asp:BoundField DataField="ScanName" HeaderText="Document" SortExpression="ScanName" >
                          <HeaderStyle HorizontalAlign="Left" />
                          </asp:BoundField>
                          <asp:BoundField DataField="ProgramName" HeaderText="Program Name" SortExpression="ProgramName" Visible="False">
                          <HeaderStyle HorizontalAlign="Left" />
                          </asp:BoundField>
                           ...
                           <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="false" 
                                     CommandName="Files" ImageUrl='<%# "Handler3.ashx?id=" + Convert.ToString(Eval("CalendarID"))%>' Text="Display" ToolTip="Display File"                                    
                                         CommandArgument='<%#Eval("CalendarID")%>' OnClientclick="javascript:DisplayFullImage(this);" Height="15px" Width="15px" />                                           
                             </ItemTemplate>
                         </asp:TemplateField>
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" CommandName="DownloadFile" 
                                     ImageUrl="~/LMS/images/downloadIcon.jpg" Text="Download"  ToolTip="Download Calendar" CommandArgument='<%#Eval("CalendarID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>   
                      </Columns>
                      ...
                      <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                       ...
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NIDCalendarUploadTable.CalendarID, NIDAcademicCalendarTable.ProgramName, NIDNVCYearTable.Name + ' ' + NIDNVCSemesterTable.Name AS Level, NIDAcademicCalendarTable.Session, NIDCalendarUploadTable.ScanName FROM NIDNVDMergeTable INNER JOIN NIDNVCYearTable ON NIDNVDMergeTable.YearID = NIDNVCYearTable.YearID INNER JOIN NIDNVCSemesterTable ON NIDNVDMergeTable.SemesterID = NIDNVCSemesterTable.SemesterID INNER JOIN NIDAcademicCalendarTable ON NIDNVDMergeTable.MergeID = NIDAcademicCalendarTable.SessionLevel INNER JOIN NIDCalendarUploadTable ON NIDAcademicCalendarTable.CalendarID = NIDCalendarUploadTable.CalendarID">
                  </asp:SqlDataSource>
                       </div>
