<%@ page language="VB" autoeventwireup="false" inherits="LMS_login, App_Web_2xlhfexi" %>
...
<head runat="server">
    ...
    <meta property="og:title" content="LoginLMS"/>
...
<body class="u-body">
   ...
   <%-- login section head  --%>
     <section class="u-align-left u-clearfix u-section-1" id="sec-db2a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">WELCOME TO OUR SCHOOL LMS</h1>
            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-shape-rectangle u-size-15 u-size-30-md u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                 <asp:ImageButton ID="ImageBAdmin" runat="server" ImageUrl="images/images2.jpg"  alt="" class="u-image u-image-default u-preserve-proportions u-image-1" />
                  <h2 class="u-heading-font u-subtitle u-text u-text-default u-text-2">ADMIN LOGIN</h2>
                  <p class="u-align-center u-text u-text-3">Authorized staff can login from this panel.</p>
                </div>
              </div>
              ...
              <div class="u-container-style u-layout-cell u-size-15 u-size-30-md u-layout-cell-4">
                <div class="u-container-layout u-container-layout-4">
                  ...
                  <h2 class="u-align-center u-heading-font u-subtitle u-text u-text-default u-text-8">STAFF LOGIN</h2>
                  <p class="u-align-center u-text u-text-9">Teachers &amp; other authorize staff members can login from here</p>
                </div>
              </div>
            </div>
          </div>
