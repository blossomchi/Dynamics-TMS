<%@ page language="VB" autoeventwireup="false" inherits="LMS_Student_StudentDashboard, App_Web_q4gru1v4" %>
...
<body>
  ...
  <%-- header head  --%>    
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-custom-font u-font-georgia u-text u-text-custom-color-1 u-title u-text-1">WELCOME&nbsp;<br/>TO&nbsp;<br />
          <br/>LEARNING&nbsp;MANAGEMENT<br/>&nbsp;SOFTWARE
        </h1>
      </div>
    </section>
        <%-- section ends --%>
