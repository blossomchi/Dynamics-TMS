...
Public Class EmployeeImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim st As String = ConfigurationManager.ConnectionStrings("ConnectionString").ToString
        Dim connection As New Data.SqlClient.SqlConnection(st)
        ...
        If id IsNot Nothing Then
            ...
            Dim sql As String = "SELECT * From ApplicantImageTable Where ID = @id"
