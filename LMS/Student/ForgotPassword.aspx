<%@ page language="VB" autoeventwireup="false" inherits="ForgotPassword, App_Web_q4gru1v4" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-Password</title>
                  ...
                  <h1>FORGOT PASSWORD</h1>
                     <div class="row">
                      <div class="col_md_12 col_lg_12 col_12">
                           ...
                           <div class="form-group">
                               <asp:Button ID="BTNSend" runat="server" Text="Send Message" Width="298px" Font-Bold="True" Font-Size="Medium" ForeColor="Maroon" Visible="True"/>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="passCode" runat="server" Width="20" Visible="False"></asp:TextBox>
                                </div>
