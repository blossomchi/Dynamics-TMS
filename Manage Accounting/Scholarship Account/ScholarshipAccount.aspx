<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_ggp0g5ma" %>
...
<head runat="server">
 ...
 <title>View Scholarship Account</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 510px; top: -33px; width: 516px; font-size:36px;margin:0;">View Scholarship Account</h3>
 </div>
                ...
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ComplementaryName" HeaderText="Name" SortExpression="ComplementaryName" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TransDate, StudentCoursesID, ComplementaryName, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM ScholarshipAccountTable ORDER BY TransDate DESC"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
