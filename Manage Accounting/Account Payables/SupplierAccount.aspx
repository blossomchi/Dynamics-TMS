<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_dzkxado5" %>
...
<head runat="server">
 ...
 <title>View suppliers Account</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 510px; top: -33px; width: 516px; font-size:36px;margin:0;">View Suppliers Account</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Accounts" Width="126px" Visible="False" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="48" AllowPaging="True" AllowSorting="True">
                        <Columns>
                            <asp:BoundField DataField="TransDate" HeaderText="Trans_Date" SortExpression="TransDate" />
                            <asp:BoundField DataField="CompanyName" HeaderText="Suppliers" SortExpression="CompanyName" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AccountsPayableTable.TransDate, SupplierHeaderTable.CompanyName, AccountsPayableTable.Account, AccountsPayableTable.AccountDetail, AccountsPayableTable.Amount, AccountsPayableTable.TransactionType, AccountsPayableTable.Remark, AccountsPayableTable.DateCreated, AccountsPayableTable.CreatedBy FROM AccountsPayableTable INNER JOIN SupplierHeaderTable ON AccountsPayableTable.SupplierID = SupplierHeaderTable.SupID ORDER BY AccountsPayableTable.TransDate DESC"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
