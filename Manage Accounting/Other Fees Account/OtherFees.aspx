<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_0vjwwmh1" %>
...
<head runat="server">
 ...
 <title>View Other Fees Account</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 475px; top: -33px; width: 574px; font-size:36px;margin:0;">VIEW OTHER FEES ACCOUNT</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Account" Width="126px" Visible="False" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="48" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="TransDate" HeaderText="Trans Date" SortExpression="TransDate" />
                            <asp:BoundField DataField="ChargesName" HeaderText="Other Fees" SortExpression="ChargesName" />
                            <asp:BoundField DataField="Account" HeaderText="Account" SortExpression="Account" />
                            <asp:BoundField DataField="AccountDetail" HeaderText="Account Details" SortExpression="AccountDetail" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TransDate, ChargesName, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM OtherfeesAccountTable ORDER BY TransDate DESC"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
