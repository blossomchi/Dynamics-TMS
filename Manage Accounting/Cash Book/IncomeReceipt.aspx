<%@ page language="VB" autoeventwireup="false" inherits="Students_Receipt, App_Web_ga0esv5h" %>
 ...
 document.write wbvers & """> </object>"
    ...
    <form id="formReceipt" runat="server">
      <div class="xr_ap" id="xr_xr" style="width: 303px; height: auto; top:0px; margin-left: -7px; margin-right: -7px; left: 10px; padding: 10px;">
          ...
          <table id="ReceiptTable" runat="server" style="position: absolute; top: 157px; left: 26px; width: 267px; height: auto" visible="True">
                <tr>
