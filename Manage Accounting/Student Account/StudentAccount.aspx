<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_capazaje" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 556px; top: -33px; width: 428px; font-size:36px;margin:0;">View Student Account</h3>
 </div>
            ...
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="38" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="SalesDate" HeaderText="Trans. Date" SortExpression="SalesDate" />
                            <asp:BoundField DataField="StudentCoursesID" HeaderText="Transaction_ID" SortExpression="StudentCoursesID" />
                    ...
                    <asp:GridView ID="SearchGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="ViewStudenInfoDS" ForeColor="Black" PageSize="5" AllowPaging="True" DataKeyNames="Transaction ID,StudentNO">
                        <Columns>
                            <asp:BoundField DataField="Transaction ID" HeaderText="Transaction ID" SortExpression="Transaction ID" ReadOnly="True" />
                            <asp:BoundField DataField="Registration Date" HeaderText="Registration Date" SortExpression="Registration Date" />
                            <asp:BoundField DataField="StudentNO" HeaderText="Student NO" SortExpression="StudentNO" ReadOnly="True" />
                            <asp:BoundField DataField="Student Name" HeaderText="Student Name" SortExpression="Student Name" ReadOnly="True" />
                    ...
                    <asp:SqlDataSource ID="ViewStudenInfoDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StudentCoursesTable.StudentCoursesID AS [Transaction ID], StudentCoursesTable.RegDate AS [Registration Date], StudentTableTable.StudentNO, StudentTableTable.FirstName + ' ' + StudentTableTable.LastName AS [Student Name] FROM StudentCoursesTable INNER JOIN StudentTableTable ON StudentCoursesTable.StudentNO = StudentTableTable.StudentNO WHERE (StudentTableTable.StudentNO = @TransactionID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtTransactionID" Name="TransactionID" PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT StudentAccountTable.SalesDate, StudentAccountTable.StudentCoursesID, StudentTableTable.FirstName + ' ' + StudentTableTable.LastName AS [Student Name], StudentAccountTable.Account, StudentAccountTable.AccountDetail, StudentAccountTable.TransactionType, StudentAccountTable.Remark, StudentAccountTable.DateCreated, StudentAccountTable.CreatedBy, StudentAccountTable.Amount FROM StudentAccountTable INNER JOIN StudentTableTable ON StudentAccountTable.StudentNO = StudentTableTable.StudentNO ORDER BY StudentAccountTable.SalesDate DESC"></asp:SqlDataSource>
                                <strong style="font-weight: 700">
