<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_5wm3ga0j" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 650px; top: -33px; width: 216px; font-size:36px;margin:0;">PROGRAM</h3>
 </div>
...
<div class="xr_ap" id="xr_xri" style="width: 1120px; height: 2231px; overflow:hidden;">
 <a href="javascript:xr_qstart(2,1364,%22index.htm%22);" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/273.png" alt="HOME" title="" onmousemove="xr_mo(this,0,event)" style="left: 355px; top: 12px; width: 53px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/274.png" alt="FACILITES" title="" onmousemove="xr_mo(this,0,event)" style="left: 407px; top: 12px; width: 79px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/275.png" alt="PROGRAMS" title="" onmousemove="xr_mo(this,0,event)" style="left: 485px; top: 12px; width: 86px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/276.png" alt="NEWS &amp; EVENT" title="" onmousemove="xr_mo(this,0,event)" style="left: 570px; top: 12px; width: 107px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/277.png" alt="ABOUT US" title="" onmousemove="xr_mo(this,0,event)" style="left: 676px; top: 12px; width: 80px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/278.png" alt="CONTACT US" title="" onmousemove="xr_mo(this,0,event)" style="left: 755px; top: 12px; width: 94px; height: 23px;"/>
 </a>
 <a href="/Staff Dasboard/StaffLogin.aspx" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/279.png" alt="STAFF" title="" onmousemove="xr_mo(this,0,event)" style="left: 850px; top: 12px; width: 56px; height: 23px;"/>
 </a>
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/179.png" alt="STUDENTS" title="" onmousemove="xr_mo(this,0,event)" style="left: 910px; top: 12px; width: 81px; height: 23px;"/>
 </a>
 <a href="StudentApplicationOnline.aspx" target="_self" onclick="return(xr_nn());">
  <img class="xr_rn_ xr_ap" src="index_htm_files/apply.png" alt="APPLY" title="" onmousemove="xr_mo(this,0,event)" style="left: 1000px; top: 12px; width: 81px; height: 23px;"/>
 </a>
 <div id="xr_xo0" class="xr_ap" style="left:0; top:0; width:1120px; height:100px; visibility:hidden;">
 <a href="#" onclick="return(false);">
  <img class="xr_rn_ xr_ap" src="index_htm_files/284.png" alt="FACILITES" title="" style="left: 412px; top: 13px; width: 68px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/285.png" alt="PROGRAMS" title="" style="left: 489px; top: 13px; width: 76px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/286.png" alt="NEWS &amp; EVENT" title="" style="left: 575px; top: 13px; width: 96px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/287.png" alt="ABOUT US" title="" style="left: 681px; top: 13px; width: 69px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/288.png" alt="CONTACT US" title="" style="left: 760px; top: 13px; width: 83px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/289.png" alt="STAFF" title="" style="left: 853px; top: 13px; width: 45px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/187.png" alt="STUDENTS" title="" style="left: 918px; top: 13px; width: 71px; height: 21px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/apply1.png" alt="APPLY" title="" style="left: 1000px; top: 13px; width: 70px; height: 21px;"/>
 </a>
 </div>
 <div id="xr_xd0"></div>
</div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Programs" Width="126px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="ProgramID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" SortExpression="SN" InsertVisible="False" Visible="False" />
                            ...
                            <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteProgram" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ProgramID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ProgramTable.SN, ProgramTable.ProgramID, ProgramTable.ProgramName, ProgramTable.Description, StaffTable.FirstName + ' ' + StaffTable.LastName AS [Login Users], ProgramTable.DateCreated FROM ProgramTable INNER JOIN StaffTable ON ProgramTable.StaffID = StaffTable.StaffId"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
                    ...
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1092px; margin-left: 0px; height: 204px; background-image: url('images/eeee.gif'); background-repeat: repeat;" visible="False">
                        <tr>
                            ...
                            <td class="auto-style12" rowspan="4" valign="top">
                                <asp:GridView ID="GVCourse" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="ProgramID" DataSourceID="SubCoursesDS" ForeColor="Black" GridLines="Vertical" Width="528px">
                                ...
                                <asp:SqlDataSource ID="SubCoursesDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ProgramID], [ProgramName] FROM [ProgramTable]"></asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14" valign="top">Program Name:</td>
                            <td class="auto-style15" valign="top">
                                <asp:TextBox ID="txtProgramName" runat="server" Width="207px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14" valign="top">Program Description:</td>
                            <td class="auto-style15" valign="top">
                                <asp:TextBox ID="txtDescription" runat="server" style="margin-left: 0px" TextMode="MultiLine" Width="207px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
