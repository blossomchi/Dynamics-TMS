<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_swou3tjc" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <script type="text/javascript">var xr_xr=document.getElementById("xr_xr")</script>
  <img class="xr_rn_ xr_ap" src="index_htm_files/306.png" alt="" title="" style="left: -4px; top: -6px; width: 1136px; height: 2248px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/324.png" alt="" title="" style="left: -1px; top: -1px; width: 1120px; height: 183px;"/>
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 542px; top: -33px; width: 443px; font-size:36px;margin:0;">CHART OF ACCOUNTS</h3>
 </div>
 <img class="xr_rn_ xr_ap xr_ax_3" src="index_htm_files/297.png" alt="" title="" style="left: 371px; top: 230px; width: 341px; height: 34px;"/>
 <img class="xr_rn_ xr_ap" src="index_htm_files/208.png" alt="NAVIGATION SOCIAL ADDRESS Plot 110 Apala Street, Off Okumagba Road. Warri, Delta State, Nigeria. CONTACT info@rolofcomputeracademy.com f: 08023118428, 08130835322, 07084993553, 08185783901  Developed by Chinyere Blossom Oyem &#61653; &#61593; &#61594; &#61799; HOME FACILITIES CONTACT" title="" style="left: -1px; top: 1867px; width: 1121px; height: 364px;"/>
 <img class="xr_rn_ xr_ap" id="autoreplace" src="index_htm_files/logo eve.png" alt="" title="" style="left: 150px; top: 41px; width: 149px; height: 133px;"/>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="Clear" runat="server" Text="Clear" Visible="False" Width="66px" ToolTip="Clear entry information." />
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Account" Width="126px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="AccountName" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="AccountID" HeaderText="ID" ReadOnly="True" SortExpression="AccountID" InsertVisible="False" />
                            <asp:BoundField DataField="AccountName" HeaderText="Accounts" ReadOnly="True" SortExpression="AccountName" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AccountChartTable.AccountID, AccountChartTable.AccountName, AssetOrLiabilityTable.AssetOrLiability, CurrentOrNonCurrentTable.CurrentOrNonCurrent, AccountChartTable.IncomeOrExpense, Cash_Bank_RelationshipTable.Cash_Bank_Relationship, ReportTypeTable.ReportType, AccountChartTable.Description FROM AccountChartTable INNER JOIN AssetOrLiabilityTable ON AccountChartTable.AssetOrLiability = AssetOrLiabilityTable.ID INNER JOIN CurrentOrNonCurrentTable ON AccountChartTable.CurrentOrNonCurrent = CurrentOrNonCurrentTable.ID INNER JOIN ReportTypeTable ON AccountChartTable.ReportType = ReportTypeTable.ID INNER JOIN Cash_Bank_RelationshipTable ON AccountChartTable.Cash_Bank_Relationship = Cash_Bank_RelationshipTable.ID"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
                <td class="style9" style="position: absolute; top: 90px; right: 270px;">
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                <asp:TextBox ID="viewTextBox3" runat="server" Visible="False" Width="16px"></asp:TextBox>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1091px; margin-left: 0px; height: 204px; background-image: url('http://localhost:56600/wwwr/Manage%20Accounting/Accounts%20Setup/Charts%20of%20Accounts/images/eeee.gif'); background-repeat: repeat;" visible="False">
                        <tr>
                            <td class="auto-style11" colspan="2" valign="top"><strong>ENTER ACCOUNTS</strong></td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style64" colspan="2" valign="top">Account Name:</td>
                        ...
                        <tr>
                            <td class="style64" colspan="2" valign="top">Asset/Liability:</td>
                            <td class="style63" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="cbAL" runat="server" DataSourceID="AssetLiabilityDS" DataTextField="AssetOrLiability" DataValueField="ID" Height="20px" Width="207px">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="AssetLiabilityDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [AssetOrLiability] FROM [AssetOrLiabilityTable]"></asp:SqlDataSource>
                            </td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style64" colspan="2" valign="top">Current/Non Current:</td>
                            <td class="style63" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="cbCurrentNonCurrent" runat="server" DataSourceID="CONC" DataTextField="CurrentOrNonCurrent" DataValueField="ID" Width="207px">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="CONC" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [CurrentOrNonCurrent] FROM [CurrentOrNonCurrentTable]"></asp:SqlDataSource>
                            </td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style64" colspan="2" valign="top">Income/Expense:</td>
                            <td class="style63" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="CBIncomeExpense" runat="server" Height="20px" Width="207px">
                        ...
                        <tr>
                            <td class="style64" colspan="2" valign="top">Cash/Bank RelationShip:</td>
                            <td class="style63" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="cbCB" runat="server" DataSourceID="CashBankDS" DataTextField="Cash_Bank_Relationship" DataValueField="ID" Width="207px">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="CashBankDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [Cash_Bank_Relationship] FROM [Cash_Bank_RelationshipTable]"></asp:SqlDataSource>
                            </td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style64" colspan="2" valign="top">Report Type:</td>
                            <td class="style63" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="cbReport" runat="server" DataSourceID="ReportDS" DataTextField="ReportType" DataValueField="ID" Width="207px">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="ReportDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [ReportType] FROM [ReportTypeTable]"></asp:SqlDataSource>
                            </td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style64" colspan="2" valign="top">Description:</td>
                            <td class="style63" valign="top">
                                <asp:TextBox ID="txtDescription" runat="server" style="margin-left: 1px" TextMode="MultiLine" Width="200px" Height="82px"></asp:TextBox>
                            </td>
                            <td class="style63" valign="top">&nbsp;</td>
                            <td class="style63" valign="top">&nbsp;</td>
                        </tr>
