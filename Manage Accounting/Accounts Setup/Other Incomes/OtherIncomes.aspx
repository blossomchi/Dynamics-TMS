<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_xpn5bxcf" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 598px; top: -33px; width: 323px; font-size:36px;margin:0;">OTHER INCOMES</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Incomes" Width="126px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="ID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="48" AllowPaging="True">
                        <Columns>
                            <asp:BoundField DataField="ID" HeaderText="ID" ReadOnly="True" SortExpression="ID" InsertVisible="False" />
                            <asp:BoundField DataField="IncomeHead" HeaderText="Income Head" SortExpression="IncomeHead" />
                            ...
                            <asp:BoundField DataField="CreatedBy" HeaderText="Created By" SortExpression="CreatedBy" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteOtherIncomes" ImageUrl="~/Staff/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, IncomeHead, DateCreated, CreatedBy FROM OtherIncomeTable"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
                <td class="style9" style="position: absolute; top: 90px; right: 270px;">
                                ...
                                <asp:TextBox ID="viewTextBox4" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                </small>
                                <asp:TextBox ID="txtOther" runat="server" Visible="False" Width="20px"></asp:TextBox>
                            ...
                            <td class="style63" valign="top">
                                <table id="dropdownTable" runat="server" style="width: 971px;  " visible="False">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style11">Other Income Names:</td>
                                        <td class="style73"><strong>
                                            <asp:TextBox ID="txtIncome" runat="server" Width="281px"></asp:TextBox>
                                            <br />
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style66">
                                            ...
                                            <strong>
                                            <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [IncomeHead] FROM [OtherIncomeTable]"></asp:SqlDataSource>
                                            <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, IncomeHead FROM OtherIncomeTable WHERE (IncomeHead = @Name)">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="viewIDTextBox1" Name="Name" PropertyName="Text" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
                                        ...
                                        <td class="style11" valign="top"><strong>
                                            <asp:Button ID="saveButton0" runat="server" OnClientClick="Confirm()" Text="Save New Income" ToolTip="Save new income" Width="188px" />
                                            </strong></td>
                                    </tr>
                                </table>
                            </td>
