<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_xzoo3zaa" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 517px; top: -33px; width: 455px; font-size:36px;margin:0;">Manage Expense Head</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Expense Head" Width="169px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="ID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ExpenseHead" HeaderText="ExpenseHead" SortExpression="ExpenseHead" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteProgram" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, ExpenseHead FROM ExpensesHeadsTable"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddHeadTable" runat="server" style="border-style: solid; border-width: medium; width: 1091px; background-color: #DBD8CA; height: 147px;" visible="False">
                        <tr>
                            <td class="style229" colspan="2" valign="top"><strong>Expenses Head.</strong>..</td>
                            <td class="style125" rowspan="4" valign="top">
                                <asp:GridView ID="HeadGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="Head" PageSize="2" style="font-size: 11px" Visible="False" Width="437px">
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="S/N" InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                                        <asp:BoundField DataField="ExpenseHead" HeaderText="Expense Head Name" SortExpression="ExpenseHead" />
                                        <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/Courses/Sub Courses/images/edit.png" Text="Select" ToolTip="View"/>
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteExpenseHeadID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                        ...
                        <tr>
                            <td class="style231" valign="top">Expense Head:</td>
                            <td class="style233" valign="top"><strong>
                                <asp:TextBox ID="txtName" runat="server" style="text-align: left; margin-left: 0px;" ToolTip="Enter expenses head" Width="315px"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                            <td class="style231" valign="top">&nbsp;</td>
                            <td class="style233" valign="top"><strong>
                                <strong style="font-weight: 700">
                                <asp:Button ID="SaveExpense" runat="server" Text="Save" ToolTip="Click to save unlock expense head." Width="66px" />
                                </strong></strong></td>
                        </tr>
                        <tr>
                            <td class="style231" valign="top">Expense Name:</td>
                            <td class="style233" valign="top"><strong>
                                <asp:TextBox ID="txtDetailName" runat="server" Enabled="False" style="text-align: left; margin-left: 0px;" ToolTip="Enter name" Width="315px"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                            <td class="style231" valign="top">Description:</td>
                            <td class="style233" valign="top"><strong>
                                <asp:TextBox ID="txtDetailDes" runat="server" Enabled="False" style="text-align: left; margin-left: 0px;" ToolTip="Enter description" Width="315px"></asp:TextBox>
                                </strong></td>
                            <td class="style125" rowspan="2" valign="top">
                                <asp:GridView ID="DetailGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="HeadDS" PageSize="4" style="font-size: 11px" Visible="False" Width="434px">
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="S/N" SortExpression="ID" />
                                        <asp:BoundField DataField="ExpensesName" HeaderText="Details Name" SortExpression="ExpensesName" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteExpenseDetailsID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                <strong>
                                <asp:SqlDataSource ID="Head" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, ExpenseHead FROM ExpensesHeadsTable WHERE (ExpenseHead = @Name)">
                                    <SelectParameters>
                        ...
                        <tr>
                            <td class="style93" valign="top"><strong><strong style="font-weight: 700">&nbsp;</strong></strong></td>
                            <td class="style232" valign="top"><strong>
                                <asp:Button ID="BTNDetails" runat="server" Enabled="False" Text="Add Expenses" Width="110px" />
                                <asp:SqlDataSource ID="HeadDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ExpenseHeadDetailTable.ExpensesName, ExpenseHeadDetailTable.Description, ExpenseHeadDetailTable.ID FROM ExpensesHeadsTable INNER JOIN ExpenseHeadDetailTable ON ExpensesHeadsTable.ID = ExpenseHeadDetailTable.ExpenseHeadID WHERE (ExpensesHeadsTable.ExpenseHead = @Name)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="txtName" Name="Name" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
