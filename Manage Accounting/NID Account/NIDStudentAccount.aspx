<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_41yj4ufx" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <script type="text/javascript">var xr_xr=document.getElementById("xr_xr")</script>
  <img class="auto-style19" src="index_htm_files/306.png" alt="" title="" style="left: -3px; top: -4px; "/>
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 456px; top: -33px; width: 628px; font-size:36px;margin:0;">View NID Student Account</h3>
 </div>
            ...
            <tr>
                <td class="style3">
                    ...
                    <strong style="font-weight: 700">
                                <asp:DropDownList class ="chosen-select" ID="CBExistingStudent"  runat="server" AutoPostBack="True" DataSourceID="ExistingStudentDS" DataTextField="NID Students" DataValueField="ApplicantID" Height="24px" Width="250px">
                                </asp:DropDownList>
                                </strong>
                    <strong>
                    <asp:Button ID="DownloadButton" runat="server" Text="Download" ToolTip="Download to excel" Visible="False" Width="95px" />
                    </strong>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="38" AllowPaging="True" DataKeyNames="ApplicantID">
                        <Columns>
                            ...
                            <asp:BoundField DataField="NID Students" HeaderText="NID Students" SortExpression="NID Students" ReadOnly="True" />
                            <asp:BoundField DataField="Account" HeaderText="Account" SortExpression="Account" />
                            <asp:BoundField DataField="AccountDetail" HeaderText="Acc. Detail" SortExpression="AccountDetail" />
                    ...
                    <asp:GridView ID="SearchGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="ViewStudenInfoDS" ForeColor="Black" PageSize="15" AllowPaging="True" DataKeyNames="ApplicantID">
                        <Columns>
                            <asp:BoundField DataField="TransDate" HeaderText="Trans Date" SortExpression="TransDate" />
                            <asp:BoundField DataField="ApplicantID" HeaderText="Applicant ID" SortExpression="ApplicantID" ReadOnly="True" />
                            <asp:BoundField DataField="NID Student" HeaderText="NID Student" SortExpression="NID Student" ReadOnly="True" />
                            <asp:BoundField DataField="Account" HeaderText="Account" SortExpression="Account" />
                            <asp:BoundField DataField="AccountDetail" HeaderText="Acc. Detail" SortExpression="AccountDetail" />
                            <asp:BoundField DataField="TransactionType" HeaderText="Transaction Type" SortExpression="TransactionType" />
                            <asp:BoundField DataField="Amount" HeaderText="Amount" SortExpression="Amount" />
                    ...
                    <asp:SqlDataSource ID="ViewStudenInfoDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NBTEStudentAccountTable.TransDate, ApplicantSignupTable.ApplicantID, ApplicantSignupTable.FirstName + ' ' + ApplicantSignupTable.LastName AS [NID Student], NBTEStudentAccountTable.Account, NBTEStudentAccountTable.AccountDetail, NBTEStudentAccountTable.TransactionType, NBTEStudentAccountTable.Amount, NBTEStudentAccountTable.Remark, NBTEStudentAccountTable.DateCreated, NBTEStudentAccountTable.CreatedBy FROM NBTEStudentAccountTable INNER JOIN ApplicantSignupTable ON NBTEStudentAccountTable.ApplicantID = ApplicantSignupTable.ApplicantID WHERE (ApplicantSignupTable.ApplicantID = @TransactionID) ORDER BY NBTEStudentAccountTable.TransDate DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtTransactionID" Name="TransactionID" PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NBTEStudentAccountTable.TransDate, ApplicantSignupTable.ApplicantID, ApplicantSignupTable.FirstName + ' ' + ApplicantSignupTable.LastName AS [NID Students], NBTEStudentAccountTable.Account, NBTEStudentAccountTable.AccountDetail, NBTEStudentAccountTable.TransactionType, NBTEStudentAccountTable.Amount, NBTEStudentAccountTable.Remark, NBTEStudentAccountTable.DateCreated, NBTEStudentAccountTable.CreatedBy FROM NBTEStudentAccountTable INNER JOIN ApplicantSignupTable ON NBTEStudentAccountTable.ApplicantID = ApplicantSignupTable.ApplicantID ORDER BY NBTEStudentAccountTable.TransDate DESC"></asp:SqlDataSource>
                                <strong style="font-weight: 700">
                                <asp:SqlDataSource ID="ExistingStudentDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ApplicantID, FirstName + ' ' + LastName AS [NID Students] FROM ApplicantSignupTable"></asp:SqlDataSource>
                                </strong>
                    <br />
                </td>
            </tr>
