<%@ page language="VB" autoeventwireup="false" inherits="Manage_Accounting_Credit_Purchases_PaymentVoucher, App_Web_kl1cjuga" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" style="width: 793px; height: 1122px; clip: rect(0px, 760px, 1000px, 0px);"><!--<![endif]-->
 ...
 <span class="xr_s1" style="position: absolute; left:382px; top:90px;">
  <span class="xr_tc" style="left: -198px; top: -11px; width: 406px;"><span class="xr_s2">ROLOF COMPUTER ACADEMY PAYMENT VOUCHER (EXPENSES)</span></span>
 </span>
 <img class="xr_ap" src="pv_htm_files/171.png" alt="" title="" style="left: 53px; top: 21px; width: 43px; height: 26px;"/>
                 ...
                 <asp:Label ID="PVID" runat="server" style="font-size: 12px"></asp:Label>
                            ...
                            <tr>
                                <td class="style19" valign="top" colspan="2" >
                                 ...
                                 <asp:Label ID="Amount4" runat="server" style="font-size: 11px; font-style: italic">Rolof Computers Academy Payment Voucher</asp:Label>
