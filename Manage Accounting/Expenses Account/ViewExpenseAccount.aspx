<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_y0kzv23u" %>
...
<head runat="server">
 ...
 <title>View Expense Account</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 540px; top: -33px; width: 428px; font-size:36px;margin:0;">View Expense Account</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Programs" Width="126px" Visible="False" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="35" AllowPaging="True" AllowSorting="True">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ExpenseName" HeaderText="Name" SortExpression="ExpenseName" />
                            <asp:BoundField DataField="Account" HeaderText="Account" SortExpression="Account" />
                            <asp:BoundField DataField="AccountDetail" HeaderText="Details" SortExpression="AccountDetail" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ExpensesAccountTable.TransDate, ExpensesHeadsTable.ExpenseHead, ExpensesAccountTable.ExpenseName, ExpensesAccountTable.Account, ExpensesAccountTable.AccountDetail, ExpensesAccountTable.Amount, ExpensesAccountTable.TransactionType, ExpensesAccountTable.Remark, ExpensesAccountTable.DateCreated, ExpensesAccountTable.CreatedBy FROM ExpensesAccountTable INNER JOIN ExpensesHeadsTable ON ExpensesAccountTable.ExpenseHeadID = ExpensesHeadsTable.ID ORDER BY ExpensesAccountTable.TransDate DESC"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
