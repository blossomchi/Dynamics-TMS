<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_fh3wl4ys" %>
...
<head runat="server">
 ...
 <title>View Discount Account</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 498px; top: -33px; width: 549px; font-size:36px;margin:0;">VIEW DISCOUNT ACCOUNT</h3>
 </div>
...
<table id="employeeTable">
            ...
            <tr>
                <td class="auto-style1">
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TransDate, StudentCoursesID, Account, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM DiscountAllowedAccountTable ORDER BY TransDate DESC"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
