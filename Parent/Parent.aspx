<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_iasdwwfi" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <script type="text/javascript">var xr_xr=document.getElementById("xr_xr")</script>
  <img class="auto-style11" src="index_htm_files/306.png" alt="" title=""/>
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 499px; top: -33px; width: 529px; font-size:36px;margin:0;">PARENT MANAGEMENT</h3>
 </div>
 ...
 <img class="xr_rn_ xr_ap" id="autoreplace" src="../images/logo%20eve.png" alt="" title="" style="left: 158px; top: 41px; width: 149px; height: 133px;"/>
<div class="xr_ap" id="xr_xri" style="width: 1120px; height: 1518px; overflow:hidden; top: 2px; left: 21px;">
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Register" Width="148px" />
                    <strong style="font-weight: 700">
                                <asp:DropDownList class ="chosen-select" ID="CBExistingStudent"  runat="server" AutoPostBack="True" DataSourceID="ExistingStudentDS" DataTextField="FullName" DataValueField="ParentID" Height="24px" Width="250px">
                                </asp:DropDownList>
                                </strong>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True" DataKeyNames="ParentID">
                        <Columns>
                            <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" SortExpression="SN" InsertVisible="False" />
                            <asp:BoundField DataField="ParentID" HeaderText="Parent ID" SortExpression="ParentID" ReadOnly="True" />
                        ...
                        <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/Staff/images/edit.png" Text="Select" ToolTip="Edit"/>
                                  </ItemTemplate>
                         </asp:TemplateField>
                           <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteParent" ImageUrl="~/Staff/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SN")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                            </Columns>
                    ...
                    <asp:GridView ID="SearchGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="ViewStudenInfoDS" ForeColor="Black" PageSize="5" AllowPaging="True" DataKeyNames="ParentID">
                        <Columns>
                            <asp:BoundField DataField="ParentID" HeaderText="ParentID" SortExpression="ParentID" ReadOnly="True" />
                            <asp:BoundField DataField="FullName" HeaderText="FullName" SortExpression="FullName" />
                            <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
                            <asp:BoundField DataField="Phone" HeaderText="Phone" SortExpression="Phone" />
                            <asp:BoundField DataField="UserID" HeaderText="User Name" SortExpression="UserID" />
                            <asp:BoundField DataField="RetypePassword" HeaderText="Password" SortExpression="RetypePassword" />
                            </Columns>
                        <FooterStyle BackColor="#CCCCCC" />
                        <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                        <PagerStyle BackColor="#CCCCCC" ForeColor="Black" HorizontalAlign="Left" />
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SN, ParentID, FullName, Email, Phone, DateCreated FROM LMSParentTB ORDER BY SN DESC"></asp:SqlDataSource>
                                <strong style="font-weight: 700">
                                <asp:SqlDataSource ID="ExistingStudentDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ParentID, FullName FROM LMSParentTB"></asp:SqlDataSource>
                                </strong>
                    <asp:SqlDataSource ID="ViewStudenInfoDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ParentID, FullName, Email, Phone, UserID, RetypePassword FROM LMSParentTB WHERE (ParentID = @TransactionID) ORDER BY SN DESC">
                        <SelectParameters>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="ChangeSessionTable" runat="server" style="background-position: center; width: 1091px; background-color: #DBD8CA; background-image: url('../Students/images/eeee.gif'); background-repeat: repeat; height: 148px;" visible="False">
                        <tr>
                            <td class="style8"  colspan="2">
                                            <asp:Label ID="LBSTitle4" runat="server" style="font-weight: 700; font-size: 16px; font-style: italic" Text="REGISTER PARENT INFORMATION"></asp:Label>
                                        </td>
                        </tr>
                        <tr>
                    ...
                    <strong style="font-weight: 700">
                                <asp:CheckBox ID="CBNidCheck" runat="server" Text="NID" AutoPostBack="True" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                </strong>
                    <span style="font-weight: 700">
                                <asp:CheckBox ID="CBCertificateCheck" runat="server" Text="CERTIFICATE" AutoPostBack="True" />
                                &nbsp;&nbsp;
                                <asp:CheckBox ID="CBNewEntryCheck" runat="server" Text="NEW ENTRY" AutoPostBack="True" />
                            </td>
                        </tr>
                                </span>
                        <tr>
                            <td class="auto-style12" >Parent&#39;s Name: </td>
                            <td class="auto-style2" ><strong style="font-weight: 700">
                                <asp:DropDownList class ="chosen-select" ID="CBCertificateParent"  runat="server" AutoPostBack="True" DataSourceID="AcademyDS" DataTextField="NameOFSponsor" DataValueField="NameOFSponsor" Height="24px" Width="626px" Visible="False">
                                </asp:DropDownList>
                                <asp:DropDownList class ="chosen-select" ID="CBNidParent"  runat="server" AutoPostBack="True" DataSourceID="NIDParent" DataTextField="FullName" DataValueField="FullName" Height="24px" Width="626px" Visible="False">
                                </asp:DropDownList>
                                </strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtFullname" runat="server" Width="624px" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >User ID :</td>
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtUserID" runat="server" Width="624px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >Password : </td>
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtPassword" placeholder="Password, not more than 14 characters" runat="server" Width="624px" TextMode="Password"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >Confirm Password :</td>
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtConPassword" placeholder="Password, not more than 14 characters" runat="server" Width="624px" TextMode="Password"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >Email :</td>
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtEmail" runat="server" Width="624px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >Phone Number :</td>
                            <td class="auto-style2" >
                                <asp:TextBox ID="txtphone" runat="server" Width="624px" onkeypress="continues()"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" >&nbsp;</td>
                            <td class="auto-style2" >
                    <asp:Button ID="SubmitBTN" runat="server" Text="Submit" Width="178px" Font-Bold="True" Font-Italic="False" Font-Size="16px" ForeColor="#0098B4" />
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                 ...
                                 <asp:TextBox ID="txtbody" runat="server" TextMode="MultiLine" Visible="False"></asp:TextBox>
                                <asp:TextBox ID="txtParentID" runat="server" style="margin-left: 0px" Visible="False" Width="27px"></asp:TextBox>
                                <asp:TextBox ID="txtStudent1" runat="server" Width="20px" Visible="False"></asp:TextBox>
                                </small>
                                <asp:TextBox ID="txtParentNo" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                        ...
                        <tr>
                            <td class="style8"  colspan="2">
                    <asp:GridView ID="ParentGV" runat="server" Width="1075px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AllowPaging="True" AllowSorting="True" Visible="False" DataKeyNames="ParentID" DataSourceID="ParentDS">
                        <Columns>
                            <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                            <asp:BoundField DataField="ParentID" HeaderText="Parent ID" ReadOnly="True" SortExpression="ParentID" />
                            <asp:BoundField DataField="FullName" HeaderText="Full Name" SortExpression="FullName" />
                       ...
                       <asp:TemplateField ShowHeader="False">
                        ...
                        <SortedDescendingHeaderStyle BackColor="#383838" />
                                ...
                                <asp:SqlDataSource ID="ParentDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SN, ParentID, FullName, UserID, RetypePassword, Email, Phone FROM LMSParentTB ORDER BY SN DESC"></asp:SqlDataSource>
                                <asp:TextBox ID="txtTransactionID" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                <br />
                                <strong style="font-weight: 700">
                                <asp:SqlDataSource ID="NIDParent" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT FullName FROM ParentInformationTable"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="AcademyDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NameOFSponsor FROM StudentTableTable WHERE (NameOFSponsor &lt;&gt; N'self') AND (NameOFSponsor &lt;&gt; N'' AND NameOFSponsor &lt;&gt; N'PARENT' AND NameOFSponsor &lt;&gt; N'PARENTS') GROUP BY NameOFSponsor"></asp:SqlDataSource>
                                </strong>
                            </td>
                        </tr>
                        <tr>
