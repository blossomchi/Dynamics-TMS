<%@ page language="VB" autoeventwireup="false" inherits="Diplom, App_Web_bdpptmfb" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-Diploma</title>
...
<form>
 ...
 <ul>
    <li>Animation and Film Making	 </li>		
         <li>Photography and Film Making</li>		
<li>Digital Marketing	</li>		
<li>Computer Hardware and Networking Engineering</li>	
...
<p>The programme leads to the award of Diploma Certificate which enables candidates to:</p>
 <ul>
<li>Gain employment in any area of the economy and in the global arena.</li>
<li>Establish a profitable business and be self-employed while employing others to work for you.</li>
            </ul>

    <p>ADMISSION REQUIREMENTS</p>
    <ul>
<li>Senior Secondary School Certificate or
 its equivalent</li>
