<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_1xvkvcr1" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 448px; top: -33px; width: 730px; font-size:36px;margin:0;">LINK SESSION AND SEMSESTER</h3>
 </div>
         ...
         <div class="auto-style23" id="tableContent" style="margin-left: -561px;">
            ...
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True" DataKeyNames="SessionSemesterID">
                        <Columns>
                            <asp:BoundField DataField="SessionSemesterID" HeaderText="SN" SortExpression="SessionSemesterID" InsertVisible="False" ReadOnly="True"/>
                            ...
                            <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="false" 
                                  CommandName="DeleteFeesGroupID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SessionSemesterID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                            </Columns>
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SessionSemesterID, SessionName, SemesterName, DateCreated FROM SessionSemesterTable"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable0" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; margin-left: 0px; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; background-repeat: repeat; background-color: #FFFFFF;" visible="False" class="auto-style25">
                        <tr>
                            <td class="auto-style27" valign="top" colspan="2"><strong><em>Enter&nbsp; Session And Semester</em></strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style14" valign="top">Session&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="TxtSessionName" runat="server" Width="550px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14" valign="top">Semester&nbsp;&nbsp; :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="TxtSemesterName" runat="server" Width="550px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:Button ID="saveButton0" runat="server" onclientclick=" " Text="Save" Width="66px" ToolTip="save " />
                        ...
                        <tr>
                            <td class="auto-style14" valign="top" colspan="2">
                                            <asp:GridView ID="GridView6" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="HeaderDS" ForeColor="#333333" GridLines="None" PageSize="12" Width="1062px" DataKeyNames="SessionSemesterID" ShowFooter="True">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="SessionSemesterID" HeaderText="SN" SortExpression="SessionSemesterID" ReadOnly="True" InsertVisible="False"/>
                                                    <asp:BoundField DataField="SessionName" HeaderText="Session Name" SortExpression="SessionName" />
                                                     <asp:BoundField DataField="SemesterName" HeaderText="Semester Name" SortExpression="SemesterName" />
                                                    <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                                                 <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="false" 
                                  CommandName="DeleteSessionSemesterID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SessionSemesterID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <asp:SqlDataSource ID="HeaderDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SessionSemesterID, SessionName, SemesterName, DateCreated FROM SessionSemesterTable">
                                            </asp:SqlDataSource>
                                <strong><span style="font-size: 8pt"><small><small><small><small>
                                <small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small>
