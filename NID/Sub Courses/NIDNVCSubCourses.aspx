<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_rnzgxmw3" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 458px; top: -33px; width: 630px; font-size:36px;margin:0;">NID AND NVC SUB-COURSES</h3>
 </div>
...
<table id="employeeTable" >
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Sub Courses" Width="147px" />
                    <strong style="font-weight: 700">
                    <asp:Button ID="Search" runat="server" Text="Search" Width="134px" />
                                <asp:DropDownList class ="chosen-select" ID="CBSearch"  runat="server" AutoPostBack="True" DataSourceID="StaffViewDS" DataTextField="SubCourseName" DataValueField="SubCourseCode" Height="30px" Width="350px" Visible="False">
                                </asp:DropDownList>
                                </strong>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="SN" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="50" AllowPaging="True" style="text-align: left" AllowSorting="True">
                        <Columns>
                            ...
                            <asp:BoundField DataField="SubCourseName" HeaderText="Course Name" SortExpression="SubCourseName" />
                            ...
                            <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteCourse" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SN")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:GridView ID="SearchStaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="SubCourseCode" DataSourceID="SearchDS" ForeColor="Black" PageSize="4" AllowPaging="True" Visible="False">
                        <Columns>
                            <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" SortExpression="SN" InsertVisible="False" />
                            <asp:BoundField DataField="SubCourseCode" HeaderText="Course Code" SortExpression="SubCourseCode" ReadOnly="True" />
                            <asp:BoundField DataField="SubCourseName" HeaderText="Course Name" SortExpression="SubCourseName" />
                            <asp:BoundField DataField="Login Users" HeaderText="Login Users" SortExpression="Login Users" ReadOnly="True" />
                               <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                                                    <asp:TemplateField ShowHeader="False">
                    ...
                    <asp:SqlDataSource ID="SearchDS" runat="server" ConnectionString="<%$ ConnectionStrings:rolfStudentConnectionString1 %>" SelectCommand="SELECT NIDNVCSubCourses.SN, NIDNVCSubCourses.SubCourseCode, NIDNVCSubCourses.SubCourseName, StaffTable.FirstName + ' ' + StaffTable.LastName AS [Login Users], NIDNVCSubCourses.DateCreated FROM StaffTable INNER JOIN NIDNVCSubCourses ON StaffTable.StaffId = NIDNVCSubCourses.CreatedBy WHERE (NIDNVCSubCourses.SubCourseCode = @subCode)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="CBSearch" Name="subCode" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NIDNVCSubCourses.SN, NIDNVCSubCourses.SubCourseCode, NIDNVCSubCourses.SubCourseName, StaffTable.FirstName + ' ' + StaffTable.LastName AS [Login Users], NIDNVCSubCourses.DateCreated FROM StaffTable INNER JOIN NIDNVCSubCourses ON StaffTable.StaffId = NIDNVCSubCourses.CreatedBy"></asp:SqlDataSource>
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                <asp:TextBox ID="courses" runat="server" Visible="False" Width="16px"></asp:TextBox>
                                <small><small><small><small>
                                <small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                <asp:TextBox ID="AAmount" runat="server" Visible="False" Width="16px"></asp:TextBox>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center;  border-top-left-radius: 20px; border-top-right-radius: 20px; border-style: solid; border-width: medium; width: 1091px; margin-left: 0px; height: 204px; background-image: ; background-repeat: repeat; background-color: #FFFFFF;" visible="False">
                        <tr>
                            <td class="auto-style13" colspan="2" valign="top"><strong><em>Enter Sub Courses</em></strong></td>
                            <td class="style63" rowspan="6" valign="top">
                                <asp:GridView ID="GVCourse" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="SN" DataSourceID="SubCoursesDS" ForeColor="Black" GridLines="Vertical" Width="566px">
                                    <AlternatingRowStyle BackColor="#CCCCCC" />
                                    <Columns>
                                        <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                                        <asp:BoundField DataField="SubCourseCode" HeaderText="Sub Course Code" SortExpression="SubCourseCode" />
                                        <asp:BoundField DataField="SubCourseName" HeaderText="Course Name" SortExpression="SubCourseName" />
                                    </Columns>
                                    <FooterStyle BackColor="#CCCCCC" />
                                    <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                                ...
                                <asp:SqlDataSource ID="SubCoursesDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [SN], [SubCourseCode], [SubCourseName] FROM [NIDNVCSubCourses]"></asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" valign="top">Sub Code :</td>
                            <td class="auto-style11" valign="top">
                                <asp:TextBox ID="txtSubCode" runat="server" style="margin-left: 0px" Width="207px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style12" valign="top">Course Name:</td>
                            <td class="auto-style11" valign="top">
                                <asp:TextBox ID="txtCourseName" runat="server" TextMode="MultiLine" Width="207px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
