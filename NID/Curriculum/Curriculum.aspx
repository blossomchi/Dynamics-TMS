<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_jmuncfml" %>
...
<head runat="server">
 ...
 <!--[if IE]><script type="text/javascript" src="index_htm_files/prs.js"></script><![endif]-->
    <br />
    <!--[if !IE]>--><script type="text/javascript" src="index_htm_files/prs3.js"></script><!--<![endif]-->
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 548px; top: -33px; width: 410px; font-size:36px;margin:0;">CURRICULUM</h3>
 </div>
            ...
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="Search" runat="server" Text="Search" Width="134px" />
                                <asp:DropDownList class ="chosen-select" ID="CBSearch"  runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Department Courses" DataValueField="DepartmentCourseID" Height="30px" Width="350px" Visible="False">
                                </asp:DropDownList>
                    <asp:Button ID="Download" runat="server" Text="Download Form" Width="120px" ToolTip="Click to download student application form" Visible="False" />
                                </strong>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    ...
                    <asp:GridView ID="SearchStaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="DepartmentCourseID" DataSourceID="SearchDS" ForeColor="Black" PageSize="4" AllowPaging="True" Visible="False">
                        <Columns>
                            <asp:BoundField DataField="DepartmentCourseID" HeaderText="ID" ReadOnly="True" SortExpression="DepartmentCourseID" InsertVisible="False" />
                            <asp:BoundField DataField="Program" HeaderText="Program" SortExpression="Program" ReadOnly="True" />
                            <asp:BoundField DataField="Department" HeaderText="Department" SortExpression="Department" />
                            <asp:BoundField DataField="Session" HeaderText="Session" SortExpression="Session" ReadOnly="True" />
                               <asp:BoundField DataField="Duration" HeaderText="Duration" SortExpression="Duration" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Course" SortExpression="CourseName">
                                            <ItemTemplate>
                                             ...
                                             <FooterTemplate>
                                         <asp:Label ID="GrandLabel1" runat="server" Font-Bold="true" ForeColor="Black">Total:</asp:Label><br />
                                     </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="L" SortExpression="L">
                                             <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("L") %>'></asp:Label>
                                            </ItemTemplate>
                                             <FooterTemplate>
                                         <asp:Label ID="lblTotalL" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="T" SortExpression="T">
                                            <ItemTemplate>
                                             ...
                                             <FooterTemplate>
                                         <asp:Label ID="lblTotalT" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="P" SortExpression="P">
                                           <ItemTemplate>
                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("P") %>'></asp:Label>
                                            </ItemTemplate>
                                              <FooterTemplate>
                                         <asp:Label ID="lblTotalP" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="CU" SortExpression="CU">
                                            <ItemTemplate>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("CU") %>'></asp:Label>
                                            </ItemTemplate>
                                              <FooterTemplate>
                                         <asp:Label ID="lblTotalCU" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="CH" SortExpression="CH">
                                          <ItemTemplate>
                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("CH") %>'></asp:Label>
                                            </ItemTemplate>
                                             <FooterTemplate>
                                         <asp:Label ID="lblTotalCH" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                        </asp:TemplateField>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; margin-left: 0px; border-top-left-radius: 20px; border-top-right-radius: 20px; background-repeat: repeat; background-color: #FFFFFF;" visible="False" class="auto-style25">
                        <tr>
                            <td class="auto-style13" colspan="2" valign="top"><em><strong>Enter Curriculum For Departments </strong></em></td>
                    ...
                    <asp:Button ID="saveButton" runat="server" onclientclick=" " Text="Save" Width="66px" ToolTip="save " Visible="False" />
                                <strong><span style="font-size: 8pt"><small><small><small><small>
                                <small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 250px">
                    <table id="AddItemTable0" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; margin-left: 0px; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; background-repeat: repeat; background-color: #FFFFFF;" visible="False" class="auto-style25">
                        <tr>
                            <td class="auto-style27" valign="top" colspan="2"><strong><em>Detail Courses</em></strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Course :</td>
                            <td class="auto-style14" valign="top">
                                <asp:Label ID="LBCourses" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Lecture (L) :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtLecture" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Tutorial (T) :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtTutorial" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Practical (P) :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtPractical" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Credit Unit (CU) :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtCU" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Contact Hour Per Week (CH) : </td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtCH" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">Presequiste :</td>
                            <td class="auto-style14" valign="top">
                                <asp:TextBox ID="txtPresequite" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style28" valign="top">&nbsp;</td>
                            <td class="auto-style14" valign="top">
                    ...
                    <small><small><small><small><small>
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                <asp:TextBox ID="SubCourseDetailsID" runat="server" Visible="False" Width="16px"></asp:TextBox>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                            ...
                                            <asp:GridView ID="GridView6" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="HeaderDS" ForeColor="#333333" GridLines="None" PageSize="12" Width="1062px" DataKeyNames="SN" ShowFooter="True">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CourseCode" HeaderText="Course Code" SortExpression="CourseCode" />
                                                     <asp:TemplateField HeaderText="Course " SortExpression="CourseName">
                                                        <ItemTemplate>
                                                             <asp:Label ID="Label6" runat="server" Text='<%# Bind("CourseName") %>'></asp:Label>
                                                         </ItemTemplate>
                                                          <FooterTemplate>
                                         <asp:Label ID="GrandLabel1" runat="server" Font-Bold="true" ForeColor="Black">Total:</asp:Label><br />
                                     </FooterTemplate>
                                                     ...
                                                     <asp:TemplateField HeaderText="L" SortExpression="L">
                                                         <ItemTemplate>
                                                             <asp:Label ID="Label1" runat="server" Text='<%# Bind("L") %>'></asp:Label>
                                                         </ItemTemplate>
                                                          <FooterTemplate>
                                         <asp:Label ID="lblTotalL" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="T" SortExpression="T">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("T") %>'></asp:Label>
                                                        </ItemTemplate>
                                                         <FooterTemplate>
                                         <asp:Label ID="lblTotalT" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="P" SortExpression="P">
                                                       <ItemTemplate>
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("P") %>'></asp:Label>
                                                        </ItemTemplate>
                                                         <FooterTemplate>
                                         <asp:Label ID="lblTotalP" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="CU" SortExpression="CU">
                                                       <ItemTemplate>
                                                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("CU") %>'></asp:Label>
                                                        </ItemTemplate>
                                                         <FooterTemplate>
                                         <asp:Label ID="lblTotalCU" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="CH" SortExpression="CH">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("CH") %>'></asp:Label>
                                                        </ItemTemplate>
                                                         <FooterTemplate>
                                         <asp:Label ID="lblTotalCH" runat="server" Font-Bold="true" ForeColor="Black"></asp:Label><br />
                                         </FooterTemplate>
                    ...
                    <strong style="font-weight: 700">
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NIDNVCDepartmentCourseHeaderTable.DepartmentCourseID, NIDNVCTable.FullPartTime + ' ' + NIDNVCTable.ProgramName + ' ' + NIDNVCCourseTable.DepartmentName + ' ' + NIDNVCYearTable.Name + ' ' + NIDNVCSemesterTable.Name + ', ' + NIDNVCCourseTable.Duration AS [Department Courses] FROM StaffTable INNER JOIN NIDNVCDepartmentCourseHeaderTable ON StaffTable.StaffId = NIDNVCDepartmentCourseHeaderTable.CreatedBy INNER JOIN NIDNVDMergeTable ON NIDNVCDepartmentCourseHeaderTable.MergeID = NIDNVDMergeTable.MergeID INNER JOIN NIDNVCCourseTable ON NIDNVCDepartmentCourseHeaderTable.DepartmentID = NIDNVCCourseTable.ID INNER JOIN NIDNVCTable ON NIDNVCCourseTable.ProgramID = NIDNVCTable.ID INNER JOIN NIDNVCYearTable ON NIDNVDMergeTable.YearID = NIDNVCYearTable.YearID INNER JOIN NIDNVCSemesterTable ON NIDNVDMergeTable.SemesterID = NIDNVCSemesterTable.SemesterID">
                                            </asp:SqlDataSource>
                                </strong>
                                <br />
                                <br />
