<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_u2nd2wu3" %>
...
<head runat="server">
 ...
 <title>NINV / NVC Department</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 458px; top: -33px; width: 630px; font-size:36px;margin:0;">NID AND NVC DEPARTMENT</h3>
 </div>
         ...
         <div class="xr_ap" id="tableContent" style="top: 257px; width: 98%; height: auto; left:51%; margin-left: -561px;">
            ...
            <tr>
                <td class="auto-style1">
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT NIDNVCCourseTable.ID, NIDNVCTable.ProgramName + ' ' + NIDNVCTable.FullPartTime AS Program, NIDNVCCourseTable.DepartmentName, NIDNVCCourseTable.Duration, StaffTable.FirstName + ' ' + StaffTable.LastName AS [Entered By], NIDNVCCourseTable.DateCreated FROM NIDNVCCourseTable INNER JOIN StaffTable ON NIDNVCCourseTable.CreatedBy = StaffTable.StaffId INNER JOIN NIDNVCTable ON NIDNVCCourseTable.ProgramID = NIDNVCTable.ID ORDER BY NIDNVCCourseTable.ID"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1091px; margin-left: 0px; height: 204px;  border-top-left-radius: 20px; border-top-right-radius: 20px; background-repeat: repeat; background-color: #FFFFFF;" visible="False">
                        <tr>
                            <td class="auto-style13" colspan="2" valign="top"><strong><em>Enter Programs</em></strong></td>
                            <td class="auto-style12" rowspan="6" valign="top">
                                <br />
                                <br />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style16" valign="top">Program Name:</td>
                            <td class="auto-style17" valign="top">
                                <asp:DropDownList class ="chosen-select" ID="cbProgram" runat="server" AutoPostBack="True" DataSourceID="ProgDS" DataTextField="Program" DataValueField="ID" Height="21px" Width="550px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style16" valign="top">Departmental Code :</td>
                            <td class="auto-style17" valign="top">
                                <strong>
                                <asp:TextBox ID="txtCourseID" runat="server" Width="550px"></asp:TextBox>
                            &nbsp;</strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style18" valign="top">Department :</td>
                            <td class="auto-style19" valign="top">
                                <asp:TextBox ID="txtName" runat="server" Width="550px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style21" valign="top">Duration :</td>
                            <td class="auto-style22" valign="top">
                                <asp:TextBox ID="txtDuration" runat="server" Width="550px" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 360px">
                    ...
                    <asp:SqlDataSource ID="ProgDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, ProgramName + ' ' + FullPartTime + ' ' + Duration AS Program FROM NIDNVCTable"></asp:SqlDataSource>
