<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_f5vst34n" %>
...
<head runat="server">
 ...
 <title>Download/View Curriculum</title>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 448px; top: -33px; width: 610px; font-size:36px;margin:0;">DOWNLOAD / VIEW CURRICULUM</h3>
 </div>
         ...
         <div class="auto-style23" id="tableContent" style="margin-left: -561px;">
            ...
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create " Width="126px" Visible="False" />
                    <strong style="font-weight: 700">
                    <asp:Button ID="Search" runat="server" Text="Search" Width="134px" Visible="False" />
                    ...
                    <asp:Button ID="Download" runat="server" Text="Download Form" Width="120px" ToolTip="Click to download NID Software Engineering Technology" />
                                </strong>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True" DataKeyNames="DepartmentCourseID" Visible="False">
                        <Columns>
                    ...
                    <table id="CourseDetailsTable" runat="server" style="background-color: #A1C0E1" visible="False">
                        <tr>
