<%@ WebHandler Language="VB" Class="SeminarImageHandler" %>
...
Public Class SeminarImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If id IsNot Nothing Then
            ...
            Dim sql As String = "SELECT * From SeminarStudentPicTable Where ID = @id"
