<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_5t55xdeg" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 499px; top: -33px; width: 529px; font-size:36px;margin:0;">CERTIFICATE MANAGEMENT</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Certificate" Width="148px" />
                </td>
            </tr>
            <tr>
                ...
                <td class="style9" style="position: absolute; top: 90px">
                    ...
                    <asp:GridView ID="SessionGV" runat="server" Width="1075px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SessionDSSS" ForeColor="Black" AllowPaging="True" AllowSorting="True" Visible="False" DataKeyNames="SN">
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="SessionEvening" HeaderText="Evening" SortExpression="SessionEvening" />
                            <asp:CheckBoxField DataField="SessionWeekend" HeaderText="Weekend" SortExpression="SessionWeekend" />
                            <asp:CheckBoxField DataField="SessionRegular" HeaderText="Regular" SortExpression="SessionRegular" />
