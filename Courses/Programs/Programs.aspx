<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_pk1oz3co" %>
...
<table id="employeeTable">
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1092px; margin-left: 0px; height: 204px; border-top-left-radius: 20px; border-top-right-radius: 20px; background-repeat: repeat; background-color: #FFFFFF;" visible="False">
                        <tr>
                            <td class="auto-style13" colspan="2" valign="top">&nbsp;</td>
                            <td class="auto-style12" rowspan="5" valign="top">
