<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_mnpq5lba" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 501px; top: -33px; width: 529px; font-size:36px;margin:0;">CHANGE STUDENT SESSION</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Change Session" Width="126px" />
            ...
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True">
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="SessionMorning" HeaderText="Morning" SortExpression="SessionMorning" />
                            <asp:CheckBoxField DataField="SessionAfternoon" HeaderText="Afternoon" SortExpression="SessionAfternoon" />
                            <asp:CheckBoxField DataField="SessionWeekend" HeaderText="Weekend" SortExpression="SessionWeekend" />
                            <asp:BoundField DataField="ProgramDays" HeaderText="Program Days" SortExpression="ProgramDays" />
                    ...
                    <asp:GridView ID="SearchStaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SearchDDDDDS" ForeColor="Black" AllowPaging="True" Visible="False">
                        <Columns>
                            <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" SortExpression="SN" InsertVisible="False" />
                            <asp:BoundField DataField="Transaction ID" HeaderText="Transaction ID" SortExpression="Transaction ID" />
                    ...
                    <asp:SqlDataSource ID="SearchDDDDDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT OfficialInformationTable.OfficialSN AS SN, StudentCoursesTable.StudentCoursesID AS [Transaction ID], StudentCoursesTable.StudentNO, StudentTableTable.FirstName + ' ' + StudentTableTable.LastName AS [Student Name], OfficialInformationTable.SessionMorning, OfficialInformationTable.SessionAfternoon, OfficialInformationTable.SessionWeekend, OfficialInformationTable.ProgramDays, CoursesRegisteredForStudentTable.Name FROM OfficialInformationTable INNER JOIN StudentCoursesTable ON OfficialInformationTable.StudentCoursesID = StudentCoursesTable.StudentCoursesID INNER JOIN StudentTableTable ON StudentCoursesTable.StudentNO = StudentTableTable.StudentNO INNER JOIN CoursesRegisteredForStudentTable ON OfficialInformationTable.OfficialSN = CoursesRegisteredForStudentTable.OfficialID WHERE (StudentCoursesTable.Comment = N'NEW STUDENT') AND (StudentCoursesTable.StudentNO = @StuNO) ORDER BY SN DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="CBSearch" Name="StuNO" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <br />
                </td>
