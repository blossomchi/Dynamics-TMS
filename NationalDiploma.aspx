<%@ page language="VB" autoeventwireup="false" inherits="NationalDiploma, App_Web_bdpptmfb" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-ND</title>
    ...
    <form>
        ...
        <div class="col_md_11 col_lg_11 col_11" id="h">
         ...
         <div class="row" id="container">
           <div class="col_12">
               <div class="mainHead">
                   <h1>National Diploma Programme</h1>
                     <h3>  Application are invited from qualified candidates for admission into the below accredited courses for the 2017/2018 Academic Session.</h3>
                   <hr />
                                 </div>
               <div class="row">
                   <div class="col_12">
                      <div class="writeup">
                          <p>2 years National Diploma (ND) in:
        </p>
 <ul>
      ...
      <li>Networking & System Security  </li>
                          ...
                          <p>The programme leads to the award of National Diploma (ND) which enables candidates to:</p>
<ul>
      <li>Gain Direct Entry Admissions into any University in Nigeria and Abroad </li>
      <li>Gain Direct Entry Admissions into Higher National Diploma programmes in any Polytechnic in Nigeria and Abroad</li>
      <li>Gain employment into the Private and Public sectors of the economy and in the global arena.  </li>
      <li>Establish a profitable business and be self-employed while employing others to work for you.  </li>
      </ul>
    <p>ADMISSION REQUIREMENTS</p>
<p>(i)	JAMB UTME CANDIDATES</p>
<ul>
      <li>Five credit passes in SSCE/GCE O’Level at WAEC, NECO, NABTEB in not more than two sittings </li>
      <li>Cut-off mark of 100 and above  </li>
           </ul>

   <p>(ii)	DIRECT ADMISSION </p> 
    <ul>
      <li>ND, HND, NCE or First Degree </li>
