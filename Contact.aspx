<%@ page language="VB" autoeventwireup="false" inherits="Contact, App_Web_mfpxbfvo" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-Contact</title>
               ...
               <div class="row">
                   <div class="col_12">
                       <div class="vision">
                                   <h1>ADDRESS</h1>
                              <hr />
                                   <p>110 Apala Street Warri, Delta State, Nigeria.</p>
                               </div>
                       <div class="corevalues">
                              <h1>PHONE NUMBER</h1>
                              <hr/>
                            <p>Tel: +234 813 533 1745, +234 818 578 3901</p>
                            <p>WhatsApp: +234 812 795 8826</p>
                       ...
                       <div class="corevalues">
                              ...
                              <hr/>
                             <ul>
                             <li><a href="mailto:enquiries@rolofcomputeracademy.edu.ng?Subject=Hello%20again" target="_top">enquiries@rolofcomputeracademy.edu.ng</a></li>
                             <li><a href="mailto:admissions@rolofcomputeracademy.edu.ng?Subject=Hello%20again" target="_top">admissions@rolofcomputeracademy.edu.ng</a></li>
                           </ul>
