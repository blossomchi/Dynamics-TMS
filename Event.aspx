<%@ page language="VB" autoeventwireup="false" inherits="About, App_Web_mfpxbfvo" %>
...
<head>
   <meta name="description" content="Rolof Computer Academy is approved by FME and NBTE." />
    ...
    <title>Rolof Computer Academy-Article</title>
                  ...
                  <h1>UPCOMING EVENTS</h1>
                     <div class="row">
                      <div class="col_md_12 col_lg_12 col_12">
                        <div class="main">
                          <div class="slider">
                             <img src="images/NEW EVENT.gif" alt="recent event" class="slides"/><br><br>
                                          </div>
                        </div>
                      </div>
                    </div>
