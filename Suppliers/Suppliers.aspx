<%@ page language="VB" autoeventwireup="false" inherits="StaffRegistration, App_Web_caqkkja5" %>
...
<div class="xr_ap" id="xr_xrii"  style="width: 100%; height: 100%; top:0%; left:0%;">
 ...
 <div class="Heading_3" style="position: absolute; left:-218px; top:215px;font-size:36px;">
  <h3 class="xr_tc Heading_3" style="left: 650px; top: -33px; width: 216px; font-size:36px;margin:0;">SUPPLIERS</h3>
 </div>
...
<table id="employeeTable">
            <tr>
                <td class="style3">
                    ...
                    <asp:Button ID="AddemployeeButton" runat="server" Text="Create Suppliers" Width="126px" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <asp:GridView ID="StaffGV" runat="server" Width="1091px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="SupID" DataSourceID="StaffViewDS" ForeColor="Black" PageSize="30" AllowPaging="True" AllowSorting="True">
                        <Columns>
                            <asp:BoundField DataField="SupID" HeaderText="Sup ID" ReadOnly="True" SortExpression="SupID" />
                            <asp:BoundField DataField="CompanyName" HeaderText="Company Name" SortExpression="CompanyName" />
                            <asp:BoundField DataField="HQContact" HeaderText="HQ Contact" SortExpression="HQContact" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteSupID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SupID")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="StaffViewDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SupID, CompanyName, HQContact FROM SupplierHeaderTable"></asp:SqlDataSource>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style9" style="position: absolute; top: 90px">
                    <table id="AddItemTable" runat="server" align="left" bgcolor="#DBD7CB" style="background-position: center; border-style: solid; border-width: medium; width: 1092px; margin-left: 0px; height: 87px; background-image: url('images/eeee.gif'); background-repeat: repeat;" visible="False">
                        <tr>
                            <td class="auto-style13" colspan="2" valign="top"><strong><em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Enter Supplier Names and Banks information...</em></strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style14" valign="top">
                                <table id="SupplierTable" runat="server" align="left" style="border-style: none; border-width: medium; width: 562px; margin-right: 0px; height: 473px;" visible="True">
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Supplier ID</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:Label ID="LBSupID" runat="server" Visible="False"></asp:Label>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Company Name</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="CompanynameTextBox" runat="server" ToolTip="either your name or company" Width="140px"></asp:TextBox>
                                            <asp:Button ID="BankAccount" runat="server" Enabled="False" Text="Bank Account" ToolTip="Click to add bank information" Width="114px" />
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Account Officer</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtHQContact" runat="server" ToolTip="Enter officer name " Width="140px"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Address Line1</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtHAddress" runat="server" Height="20px" Width="140px"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Address Line2</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtHAddress0" runat="server" Height="20px" Width="140px"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">City</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtHCity" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">State</td>
                                        <td class="style66" valign="top">
                                            <asp:DropDownList ID="ddHState" class ="chosen-select" runat="server" Width="150px">
                                    ...
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Country</td>
                                        <td class="style66" valign="top">
                                            <asp:DropDownList ID="ddHCountry" class ="chosen-select" runat="server" AutoPostBack="True" DataSourceID="CountryDS" DataTextField="Name" DataValueField="Name" Width="150px">
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td class="style64" valign="top">&nbsp;</td>
                                        <td class="style64" valign="top">Fax</td>
                                        <td class="style67" valign="top"><strong>
                                            <asp:TextBox ID="txtFax" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Work Email</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtEmail" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Personal Email</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtEmail0" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Office Phone 1</td>
                                        <td class="style66" valign="top"><strong>
                                            <asp:TextBox ID="txtHPhone" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style93" valign="top">&nbsp;</td>
                                        <td class="style93" valign="top">Office Phone 2</td>
                                        <td class="style94" valign="top"><strong>
                                            <asp:TextBox ID="txtHPhone0" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top">Core Suppliers</td>
                                        <td align="left" class="style66" valign="top">
                                    ...
                                    <tr>
                                        <td class="style65" valign="top">&nbsp;</td>
                                        <td class="style65" valign="top" colspan="2"><strong>
                                            <asp:Button ID="saveButton0" runat="server" onclientclick="Confirm()" Text="Save" ToolTip="Save Suppiler Information" Width="111px" />
                                            <asp:Button ID="EditButton" runat="server" Text="Edit" Width="111px" Visible="False" />
                                            &nbsp;<asp:Button ID="CancelButton" runat="server" Text="Add More Suppliers" ToolTip="Add More Suppliers..." Visible="False" Width="164px" />
                                            </strong></td>
                                    </tr>
                                </table>
                            </td>
                            <td class="auto-style14" valign="top">
                                <table id="AccountTable" runat="server" align="left" style="border-style: solid; border-width: medium; width: 469px; background-color: #DBD8CA;" visible="False">
                                    <tr>
                                        <td class="style20" colspan="2" valign="top"><strong>Bank Information for&nbsp;<asp:Label ID="LBCompanyName" runat="server"></asp:Label>
                                            ......</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style61" valign="top">Bank Name</td>
                                        <td class="style69" valign="top">
                                            <asp:DropDownList ID="CBBankName" class ="chosen-select" runat="server" AutoPostBack="True" DataSourceID="BankDS" DataTextField="bankName" DataValueField="ID" Width="140px">
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td class="style61" valign="top">Account Type</td>
                                        <td class="style69" valign="top">
                                            <asp:DropDownList ID="cvAccountType" class ="chosen-select" runat="server" Width="140px">
                                    ...
                                    <tr>
                                        <td class="style61" valign="top">Account</td>
                                        <td class="style69" valign="top">
                                            <asp:TextBox ID="txtCAccount0" runat="server" Width="140px" Wrap="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <span class="auto-style9">
                                ...
                                <small><small><small><small><small><small><small><small><small><small><small><small>
                                <small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small><small>
                                <asp:TextBox ID="txtBankID" runat="server" style="margin-left: 0px" Visible="False" Width="27px"></asp:TextBox>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                </span>
                                </small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small></small>
                                        ...
                                        <td class="style69" valign="top"><strong>
                                            <asp:Button ID="SaveProduct0" runat="server" Text="Save" Width="113px" />
                                            <asp:Button ID="DeleteAccount" runat="server" onclientclick="Delete1()" Text="Delete" ToolTip="Delete Only Bank Information." Visible="False" Width="113px" />
                                            <asp:Button ID="Cancel0" runat="server" Text="Close" ToolTip="Close Bank information view." Width="113px" />
                                            </strong></td>
                                    </tr>
                                    <tr>
                                        <td class="style91" valign="top" colspan="2">
                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="BankAccountDs" ForeColor="#333333" GridLines="None" PageSize="6" Width="457px">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="id" HeaderText="SN" SortExpression="id"/>
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteSupID" ImageUrl="~/Courses/Sub Courses/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("id")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <asp:SqlDataSource ID="BankAccountDs" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SupplierAccountTable.id, BankTable.bankName, SupplierAccountTable.AccountType, SupplierAccountTable.Account FROM SupplierAccountTable INNER JOIN BankTable ON SupplierAccountTable.BankName = BankTable.ID WHERE (SupplierAccountTable.SuplID = @SupID)">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="LBSupID" Name="SupID" PropertyName="Text" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
                                        </td>
                                    </tr>
